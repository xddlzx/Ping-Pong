...
// node_modules/@multiversx/sdk-dapp/UI/iframe/IframeLoginButton/IframeButton.js
var import_dist2 = __toESM(require_dist());

// node_modules/@multiversx/sdk-dapp/__chunks__/chunk-LN7KA2AI.js
var import_dist = __toESM(require_dist());
var import_react = __toESM(require_react());
v();
var B = ({ token: t2, className: m = "dapp-metamask-proxy-login", children: s, callbackRoute: p2, buttonClassName: l = "dapp-default-login-button", nativeAuth: g, loginButtonText: d = "Metamask Proxy", onLoginRedirect: f, disabled: y, loginType: u2 = import_constants.IframeLoginTypes.metamask }) => {
  let [L] = vo({ callbackRoute: p2, token: t2, onLoginRedirect: f, nativeAuth: g }), c = k(t2);
  return import_react.default.createElement(v2, { onLogin: () => {
    L(u2);
  }, className: m, btnClassName: l, text: d, disabled: y || c }, s);
};
var A = u(B, { ssrStyles: () => import("./iframeLoginButton.styles-XH6R2WQN.js"), clientStyles: () => (r(), gt(p)).default });
export {
  A as IframeButton
};
//# sourceMappingURL=@multiversx_sdk-dapp_UI_iframe_IframeLoginButton_IframeButton.js.map
