...
// node_modules/@multiversx/sdk-dapp/UI/webWallet/CrossWindowLoginButton/CrossWindowLoginButton.js
var import_dist2 = __toESM(require_dist());

// node_modules/@multiversx/sdk-dapp/__chunks__/chunk-VV3OCBT5.js
var import_dist = __toESM(require_dist());
var import_react = __toESM(require_react());
v();
c();
var E = ({ token: o, className: s = "dapp-window-wallet-login", children: r, callbackRoute: a, buttonClassName: d, nativeAuth: p, loginButtonText: l = "Window Wallet", onLoginRedirect: m, disabled: g, hasConsentPopup: u, "data-testid": c2 = "accessCrossWindowWalletBtn" }) => {
  let L = k(o), [C] = Mo({ callbackRoute: a, token: o, onLoginRedirect: m, nativeAuth: p, hasConsentPopup: u });
  return import_react.default.createElement(v2, { onLogin: () => {
    C();
  }, className: s, btnClassName: d, text: l, disabled: g || L, "data-testid": c2 }, r);
};
export {
  E as CrossWindowLoginButton
};
//# sourceMappingURL=@multiversx_sdk-dapp_UI_webWallet_CrossWindowLoginButton_CrossWindowLoginButton.js.map
