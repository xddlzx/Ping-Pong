...
// node_modules/@multiversx/sdk-dapp/UI/webWallet/XaliasLoginButton/XaliasLoginButton.js
var import_dist2 = __toESM(require_dist());

// node_modules/@multiversx/sdk-dapp/__chunks__/chunk-KQ5HCLOS.js
var import_dist = __toESM(require_dist());
var import_react = __toESM(require_react());
v();
c();
S();
var U = ({ children: m, token: o, className: p = "dapp-xalias-login", callbackRoute: g, buttonClassName: d, nativeAuth: L, "data-testid": u = "xAliasLoginButton", loginButtonText: c2 = "xAlias", disabled: f2, customWalletAddress: t }) => {
  let x = k(f), n = t != null ? t : x, [B] = b({ callbackRoute: g, nativeAuth: L, token: o, customWalletAddress: n }), b2 = k2(o);
  return import_react.default.createElement(v2, { onLogin: () => {
    B();
  }, className: p, btnClassName: d, text: c2, "data-testid": u, disabled: f2 || b2 || !n }, m);
};
export {
  U as XaliasLoginButton
};
//# sourceMappingURL=@multiversx_sdk-dapp_UI_webWallet_XaliasLoginButton_XaliasLoginButton.js.map
