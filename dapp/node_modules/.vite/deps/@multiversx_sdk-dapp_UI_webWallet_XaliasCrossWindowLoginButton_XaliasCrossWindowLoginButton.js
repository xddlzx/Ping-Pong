...
// node_modules/@multiversx/sdk-dapp/UI/webWallet/XaliasCrossWindowLoginButton/XaliasCrossWindowLoginButton.js
var import_dist2 = __toESM(require_dist());

// node_modules/@multiversx/sdk-dapp/__chunks__/chunk-CJB7GQAZ.js
var import_dist = __toESM(require_dist());
var import_react = __toESM(require_react());
v();
c();
S();
var J = ({ token: t, className: d = "dapp-cross-window-xalias-login", children: m, callbackRoute: p, buttonClassName: g, nativeAuth: l, loginButtonText: L = "xAlias", onLoginRedirect: c2, disabled: f2, hasConsentPopup: u, customWalletAddress: o, "data-testid": w = "accessCrossWindowWalletBtn" }) => {
  let B = k(f), C = k2(t), [x] = Mo({ callbackRoute: p, token: t, onLoginRedirect: c2, nativeAuth: l, hasConsentPopup: u, walletAddress: o != null ? o : B });
  return import_react.default.createElement(v2, { onLogin: () => {
    x();
  }, className: d, btnClassName: g, text: L, disabled: f2 || C, "data-testid": w }, m);
};
export {
  J as XaliasCrossWindowLoginButton
};
//# sourceMappingURL=@multiversx_sdk-dapp_UI_webWallet_XaliasCrossWindowLoginButton_XaliasCrossWindowLoginButton.js.map
