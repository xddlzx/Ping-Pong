...
.dapp-core-component__pageState-styles__state {
  color: inherit;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(Lu));R0={wrapper:"dapp-core-component__pageState-styles__wrapper",state:"dapp-core-component__pageState-styles__state"}});var Wu=w((Zj,Mu)=>{n();function O0(e,o){for(var t=-1,r=e==null?0:e.length,s=Array(r);++t<r;)s[t]=o(e[t],t,e);return s}Mu.exports=O0});var Fu=w((Jj,Ou)=>{n();var F0=Er(),B0=Li(),U0="[object Symbol]";function G0(e){return typeof e=="symbol"||B0(e)&&F0(e)==U0}Ou.exports=G0});var $u=w((Qj,Vu)=>{n();var Bu=Pr(),H0=Wu(),V0=ki(),$0=Fu(),q0=1/0,Uu=Bu?Bu.prototype:void 0,Gu=Uu?Uu.toString:void 0;function Hu(e){if(typeof e=="string")return e;if(V0(e))return H0(e,Hu)+"";if($0(e))return Gu?Gu.call(e):"";var o=e+"";return o=="0"&&1/e==-q0?"-0":o}Vu.exports=Hu});var ec=w((e9,qu)=>{n();var z0=$u();function j0(e){return e==null?"":z0(e)}qu.exports=j0});var ju=w((o9,zu)=>{n();function K0(e,o,t){var r=-1,s=e.length;o<0&&(o=-o>s?0:s+o),t=t>s?s:t,t<0&&(t+=s),s=o>t?0:t-o>>>0,o>>>=0;for(var p=Array(s);++r<s;)p[r]=e[r+o];return p}zu.exports=K0});var Xu=w((n9,Ku)=>{n();var X0=ju();function Y0(e,o,t){var r=e.length;return t=t===void 0?r:t,!o&&t>=r?e:X0(e,o,t)}Ku.exports=Y0});var oc=w((t9,Yu)=>{n();var Z0="\\ud800-\\udfff",J0="\\u0300-\\u036f",Q0="\\ufe20-\\ufe2f",ev="\\u20d0-\\u20ff",ov=J0+Q0+ev,nv="\\ufe0e\\ufe0f",tv="\\u200d",rv=RegExp("["+tv+Z0+ov+nv+"]");function av(e){return rv.test(e)}Yu.exports=av});var Ju=w((r9,Zu)=>{n();function iv(e){return e.split("")}Zu.exports=iv});var cf=w((a9,af)=>{n();var Qu="\\ud800-\\udfff",cv="\\u0300-\\u036f",sv="\\ufe20-\\ufe2f",pv="\\u20d0-\\u20ff",mv=cv+sv+pv,dv="\\ufe0e\\ufe0f",_v="["+Qu+"]",nc="["+mv+"]",tc="\\ud83c[\\udffb-\\udfff]",lv="(?:"+nc+"|"+tc+")",ef="[^"+Qu+"]",of="(?:\\ud83c[\\udde6-\\uddff]){2}",nf="[\\ud800-\\udbff][\\udc00-\\udfff]",uv="\\u200d",tf=lv+"?",rf="["+dv+"]?",fv="(?:"+uv+"(?:"+[ef,of,nf].join("|")+")"+rf+tf+")*",gv=rf+tf+fv,hv="(?:"+[ef+nc+"?",nc,of,nf,_v].join("|")+")",Tv=RegExp(tc+"(?="+tc+")|"+hv+gv,"g");function xv(e){return e.match(Tv)||[]}af.exports=xv});var pf=w((i9,sf)=>{n();var yv=Ju(),Sv=oc(),bv=cf();function vv(e){return Sv(e)?bv(e):yv(e)}sf.exports=vv});var df=w((c9,mf)=>{n();var wv=Xu(),Av=oc(),Iv=pf(),kv=ec();function Lv(e){return function(o){o=kv(o);var t=Av(o)?Iv(o):void 0,r=t?t[0]:o.charAt(0),s=t?wv(t,1).join(""):o.slice(1);return r[e]()+s}}mf.exports=Lv});var lf=w((s9,_f)=>{n();var Dv=df(),Cv=Dv("toUpperCase");_f.exports=Cv});var ff=w((p9,uf)=>{n();var Nv=ec(),Pv=lf();function Ev(e){return Pv(Nv(e).toLowerCase())}uf.exports=Ev});var ac={};V(ac,{css:()=>Sf,default:()=>Mv});var Sf,Mv,ic=b(()=>{"use strict";n();Sf=`.dapp-core-component__copyButton-styles__copy {
  color: #6c757d;
