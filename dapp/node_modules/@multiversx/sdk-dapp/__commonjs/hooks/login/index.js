...
.dapp-core-component__dappModalStyles__dappModalCloseButton:focus {
  ...
  border-color: #e9ecef;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(rs));a_={dappModal:"dapp-core-component__dappModalStyles__dappModal",dappModalContent:"dapp-core-component__dappModalStyles__dappModalContent",dappModalHeader:"dapp-core-component__dappModalStyles__dappModalHeader",dappModalHeaderText:"dapp-core-component__dappModalStyles__dappModalHeaderText",dappModalBody:"dapp-core-component__dappModalStyles__dappModalBody",dappModalFooter:"dapp-core-component__dappModalStyles__dappModalFooter",dappModalCloseButton:"dapp-core-component__dappModalStyles__dappModalCloseButton"}});var __={};$e(__,{useCrossWindowLogin:()=>Dp,useExtensionLogin:()=>Ip,useGetModalLoginMethods:()=>us,useLedgerLogin:()=>hs,useMetamaskLogin:()=>ws,useOperaLogin:()=>Ep,usePasskeyLogin:()=>Ss,useWalletConnectV2Login:()=>Ts,useWebWalletLogin:()=>ct,useXaliasLogin:()=>xs});module.exports=Re(__);t();t();var xr=require("react"),Ap=require("@multiversx/sdk-extension-provider");Ke();t();t();var Ba=require("@multiversx/sdk-extension-provider"),Ua=require("@multiversx/sdk-hw-provider"),Wa=require("@multiversx/sdk-metamask-provider/out/metamaskProvider"),Ga=require("@multiversx/sdk-opera-provider"),Va=require("@multiversx/sdk-passkey-provider/out"),Ft=require("@multiversx/sdk-web-wallet-provider");F();Wo();t();var Go=require("@multiversx/sdk-web-wallet-iframe-provider/out"),dm=require("@multiversx/sdk-web-wallet-iframe-provider/out/constants");K();t();t();var hn={},xn=ko;var lm="/dapp/init",Le=e=>{switch(e==null?void 0:e.constructor){case Ft.WalletProvider:return"wallet";case xn:return"walletconnectv2";case Ua.HWProvider:return"ledger";case Ba.ExtensionProvider:return"extension";case Va.PasskeyProvider:return"passkey";case Wa.MetamaskProvider:return"metamask";case Ga.OperaProvider:return"opera";case no.CrossWindowProvider:return"crossWindow";case Go.IframeProvider:return"iframe";case ko:return"";default:return"extra"}},Ha=e=>new Ft.WalletProvider(`${e}${lm}`),$a=e=>T(void 0,null,function*(){if(!e.isInitialized())throw new Error("Unable to get version. Provider not initialized");let o=e.hwApp,{contractData:n,version:r}=yield o.getAppConfiguration();return{version:r,dataEnabled:n===Oa}}),Ie=e=>`Unable to perform ${e}, Provider not initialized`,ko=class{init(){return Promise.resolve(!1)}getAccount(){throw new Error(Ie("getAccount"))}setAccount(o){throw new Error(Ie(`setAccount: ${o}`))}login(o){throw new Error(Ie(`login with options: ${o}`))}logout(o){throw new Error(Ie(`logout with options: ${o}`))}getAddress(){throw new Error(Ie("getAddress"))}isInitialized(){return!1}isConnected(){return!1}sendTransaction(o,n){throw new Error(Ie(`sendTransaction with transactions: ${o} options: ${n}`))}signTransaction(o,n){throw new Error(Ie(`signTransaction with transactions: ${o} options: ${n}`))}signTransactions(o,n){throw new Error(Ie(`signTransactions with transactions: ${o} options: ${n}`))}signMessage(o,n){throw new Error(Ie(`signTransactions with ${o} and options ${n}`))}sendCustomMessage({method:o,params:n}){throw new Error(Ie(`sendCustomMessage with method: ${o} params: ${n}`))}sendCustomRequest(o){throw new Error(Ie(`sendSessionEvent with options: ${o}`))}ping(){return Promise.resolve(!1)}},Vo=new ko;var ja=Vo;function le(e){ja=e}function ye(){return ja||Vo}q();t();var xc=require("react"),Po=require("react-redux");t();var ar=require("@reduxjs/toolkit"),fc=require("react-redux/lib/utils/Subscription");ge();t();var Ji=A(require("lodash.throttle"));F();ge();zt();Lo();Io();var qm=[fn],jn=!1,Km=(0,Ji.default)(()=>{jo($o())},5e3),Zi=e=>o=>n=>{if(qm.includes(n.type))return o(n);let r=e.getState(),a=Ue.local.getItem(Ee.loginExpiresAt);if(!Boolean(r==null?void 0:r.account.address))return o(n);if(a==null)return jo($o());let m=Date.now();return a-m<0&&!jn?setTimeout(()=>{jn=!0,e.dispatch(mi())},1e3):(jn&&(jn=!1),Km()),o(n)};t();t();function zn(){return typeof sessionStorage!="undefined"}var _c=zn()?(rc(),Re(tc)).default:(ic(),Re(ac)).default,gc=zn()?(pc(),Re(cc)).default:[],uc=zn()?(lc(),Re(dc)).default:e=>e;qn();var M=(0,ar.configureStore)({reducer:_c,middleware:e=>e({serializableCheck:{ignoredActions:[...gc,$t.type,Ho.type],ignoredPaths:["payload.nonce","account.account.nonce","providers.accountProvider"]}}).concat(Zi)}),hc=(0,fc.createSubscription)(M),Jh=uc(M),Zh=(0,ar.configureStore)({reducer:mo});var hd={store:M,subscription:hc},ir=(0,xc.createContext)(hd),nx=(0,Po.createStoreHook)(ir),Z=(0,Po.createDispatchHook)(ir),O=(0,Po.createSelectorHook)(ir);K();t();t();t();ge();t();var yc=A(require("lodash.isequal")),Kn=require("reselect"),w=(0,Kn.createSelectorCreator)(Kn.defaultMemoize,yc.default);var We=e=>e.account,Ko=w(We,e=>e.address),Co=w(We,Ko,(e,o)=>o in e.accounts?e.accounts[o]:bn),xd=w(We,Co,(e,o)=>{let a=e,{accounts:n}=a,r=xo(a,["accounts"]);return L(h({},r),{address:o.address,account:o})}),cx=w(Co,e=>e.balance),Tc=w(Co,e=>{var o;return((o=e==null?void 0:e.nonce)==null?void 0:o.valueOf())||0}),px=w(We,e=>e.shard),bc=w(We,e=>e.ledgerAccount),sx=w(We,e=>e.walletConnectAccount),mx=w(We,e=>e.isAccountLoading),dx=w(We,e=>e.accountLoadingError),yd=w(We,e=>e.websocketEvent),Td=w(We,e=>e.websocketBatchEvent);t();var bd=e=>e.dappConfig,gx=w(bd,e=>e.shouldUseWebViewProvider);t();var ie=e=>e.loginInfo,wc=w(ie,e=>e.loginMethod),No=w(ie,Ko,(e,o)=>Boolean(o)),xx=w(ie,e=>e.walletConnectLogin),yx=w(ie,e=>e.ledgerLogin),Sc=w(ie,e=>e.walletLogin),Tx=w(ie,e=>e.isLoginSessionInvalid),Xo=w(ie,e=>e.tokenLogin),vc=w(ie,e=>e.logoutRoute),wd=w(ie,e=>e.isWalletConnectV2Initialized);t();var kc=e=>e.modals,Sx=w(kc,e=>e.txSubmittedModal),vx=w(kc,e=>e.notificationModal);t();var Ze=e=>e.networkConfig,cr=w(Ze,e=>e.network.chainId),Ix=w(Ze,e=>e.network.roundDuration),Lx=w(Ze,e=>e.network.walletConnectBridgeAddress),Ac=w(Ze,e=>e.network.walletConnectV2RelayAddress),Ic=w(Ze,e=>e.network.walletConnectV2ProjectId),Lc=w(Ze,e=>e.network.walletConnectV2Options),Ec=w(Ze,e=>e.network.walletConnectDeepLink),ve=w(Ze,e=>e.network),Pc=w(ve,e=>e.apiAddress),Cc=w(ve,e=>e.explorerAddress),Ex=w(ve,e=>{var o;return(o=e.customWalletAddress)!=null?o:e.walletAddress}),Nc=w(ve,e=>e.xAliasAddress),Sd=w(ve,e=>e.egldLabel);t();var Xn=e=>e.signedMessageInfo,Nx=w(Xn,e=>e.isSigning),Rx=w(Xn,e=>e.errorMessage),Dx=w(Xn,e=>{let o=Object.keys(e.signedSessions),n=o.length;return e.signedSessions[o[n-1]]}),Mx=w(Xn,e=>{let o=Object.keys(e.signedSessions),n=o.length;return o.length>0?o[n-1]:""});t();var Rc=e=>e.toasts,Bx=w(Rc,e=>e.customToasts),Ux=w(Rc,e=>e.transactionToasts);t();ge();var Dc={errorMessage:Yt,successMessage:Jt,processingMessage:Zt},vd=e=>e.transactionsInfo,Hx=w(vd,(e,o)=>o,(e,o)=>o!=null&&(e==null?void 0:e[Number(o)])||Dc);t();t();var Ge=require("@multiversx/sdk-core");F();t();var pr=require("@multiversx/sdk-core/out");t();t();function Yn(e){try{let o=atob(e),n=btoa(o),r=i.Buffer.from(e,"base64").toString(),a=i.Buffer.from(r).toString("base64"),s=e===n||n.startsWith(e),m=e===a||a.startsWith(e);if(s&&m)return!0}catch(o){return!1}return!1}function lo(e){return Yn(e)?atob(e):e}t();t();t();t();var Mc=e=>{let o=e!=null?e:"";return Yn(o)?pr.TransactionPayload.fromEncoded(o):new pr.TransactionPayload(o)};t();F();var Jn=({data:e,onlySetGuardian:o})=>e?o?e.startsWith("SetGuardian"):Object.values(Lt).some(n=>e.startsWith(n)):!1;function sr(e){var r,a,s;let o=h({},e);Jn({data:o.data,onlySetGuardian:!0})&&(delete o.senderUsername,delete o.receiverUsername);let n=new Ge.Transaction(h(h(L(h(L(h({value:o.value.valueOf(),data:Mc(o.data),nonce:o.nonce.valueOf(),receiver:new Ge.Address(o.receiver)},o.receiverUsername?{receiverUsername:o.receiverUsername}:{}),{sender:new Ge.Address(o.sender)}),o.senderUsername?{senderUsername:o.senderUsername}:{}),{gasLimit:(r=o.gasLimit.valueOf())!=null?r:Mt,gasPrice:(a=o.gasPrice.valueOf())!=null?a:Ot,chainID:o.chainID.valueOf(),version:new Ge.TransactionVersion((s=o.version)!=null?s:Ma)}),o.options?{options:new Ge.TransactionOptions(o.options)}:{}),o.guardian?{guardian:new Ge.Address(o.guardian)}:{}));return o.guardianSignature&&n.applyGuardianSignature(i.Buffer.from(o.guardianSignature,"hex")),o.signature&&n.applySignature(i.Buffer.from(o.signature,"hex")),n}t();t();F();t();t();t();var Ld=require("@multiversx/sdk-core/out");t();F();t();var Fc=require("@multiversx/sdk-core");re();t();var Oc=require("@multiversx/sdk-core");function Ed(e){try{let o=new Oc.Address(e);return Boolean(o.bech32())}catch(o){return!1}}function Yo(e){return(e==null?void 0:e.length)===62&&/^\w+$/.test(e)&&Ed(e)}t();t();t();var Pd=require("@multiversx/sdk-core"),Cd=A(require("bignumber.js"));K();t();t();t();var Zn="accounts";var mr="blocks";t();t();t();t();me();t();t();me();t();t();t();var Fd=A(require("bignumber.js"));F();t();var Od=require("@multiversx/sdk-core"),dr=A(require("bignumber.js"));F();t();var Dd=A(require("bignumber.js"));t();dr.default.config({ROUNDING_MODE:dr.default.ROUND_FLOOR});t();t();t();F();t();t();t();t();F();t();F();t();var Bd=require("@multiversx/sdk-core");F();t();var Zo=require("@multiversx/sdk-core"),Wd=A(require("bignumber.js"));F();t();t();var Ud=A(require("bignumber.js"));F();t();F();t();t();t();t();t();t();F();t();F();t();F();t();me();var Vd=["reDelegateRewards","claimRewards","unBond"],Hd=["wrapEgld","unwrapEgld"],$d=["unStake"],jd=["unDelegate"];t();t();t();F();t();var Kd=A(require("bignumber.js"));t();t();me();t();var Yd=A(require("bignumber.js"));t();t();t();t();var Zd=A(require("bignumber.js"));re();t();t();t();t();K();t();var ol=require("@multiversx/sdk-web-wallet-provider");F();t();var el=A(require("qs"));t();_e();Eo();t();Eo();var kw={search:so()?window.location.search:"",removeParams:[]};t();t();t();Te();t();me();t();t();Te();t();var nl=A(require("linkifyjs"));t();F();t();var tl=A(require("bignumber.js"));t();re();t();t();K();t();K();t();t();t();me();t();me();t();var rl=A(require("bignumber.js"));F();me();t();me();t();var Hc=require("react");re();t();t();me();t();t();var al=require("@multiversx/sdk-core/out"),il=A(require("bignumber.js"));me();t();re();t();t();re();var xv=[{label:"Raw",value:"raw"},{label:"Text",value:"text"},{label:"Decimal",value:"decimal"},{label:"Smart",value:"smart"}];t();var $c=require("react");re();Te();t();var pl=require("react");me();var Av=["create","localMint","ESDTLocalMint","addQuantity","burn","localBurn","ESDTLocalBurn","wipe","writeLog","signalError"];er();t();var et=e=>e.transactions,en=w(et,e=>e.signedTransactions),fk=w(et,e=>e.signTransactionsError),hk=w(et,e=>e.signTransactionsCancelMessage),ot=e=>o=>Object.entries(o).reduce((n,[r,a])=>(e(a.status)&&(n[r]=a),n),{}),xk=w(en,ot(Ui)),yk=w(en,ot(Un)),Tk=w(en,ot(Wn)),bk=w(en,ot(Gi)),wk=w(et,e=>{var o;return(e==null?void 0:e.transactionsToSign)==null?null:L(h({},e.transactionsToSign),{transactions:((o=e==null?void 0:e.transactionsToSign)==null?void 0:o.transactions.map(n=>sr(n)))||[]})}),Sk=w(en,(e,o)=>o,(e,o)=>o!=null?(e==null?void 0:e[o])||{}:{});function Q(){return No(M.getState())}Ye();_e();_e();t();t();Wo();re();var fe=e=>(Object.values(oe).forEach(o=>{if(o!==(e==null?void 0:e.skipLoginMethod))switch(o){case"crossWindow":{let n=no.CrossWindowProvider.getInstance();n.isInitialized()&&n.dispose();break}case"iframe":{let n=Go.IframeProvider.getInstance();n.isInitialized()&&n.dispose();break}default:break}}),null);t();var kp=require("react"),rt=require("@multiversx/sdk-core");t();t();var gr=()=>O(Co);t();t();var jc=()=>{let e=ye(),o=Le(e);return{provider:e,providerType:o}};t();t();t();t();t();t();t();var Ro=A(require("react"));var sl=(0,Ro.createContext)({}),cA=M.getState();function nt(){let e=(0,Ro.useContext)(sl);if(e===void 0||Object.values(e).length===0)throw new Error("useAxiosInterceptorContext must be used within an AxiosInterceptorContextProvider");return e}t();var zc=A(require("react"));t();var ur=A(require("react")),ml=A(require("axios"));var qc=()=>{try{let{loginInfo:e,isLoggedIn:o}=nt();return L(h({},e),{isLoggedIn:o})}catch(e){let o=O(ie),n=O(No);return L(h({},o),{isLoggedIn:n})}};var Kc=()=>{let{isLoggedIn:e}=qc();return e};t();t();ge();t();t();var vp=require("@multiversx/sdk-native-auth-client");t();var Zc=A(require("axios"));t();t();t();function Xc(e){return T(this,null,function*(){return yield new Promise(o=>{setTimeout(()=>o(),e)})})}t();var Yc=(e,o,n,r=0)=>T(void 0,null,function*(){try{return yield e(...n)}catch(a){return r<o.retries?((o==null?void 0:o.delay)!=null&&(yield Xc(o.delay)),yield Yc(e,o,n,r+1)):null}}),Jc=(e,o={retries:5,delay:500})=>(...n)=>T(void 0,null,function*(){return yield Yc(e,o,n)});var dl=4,ll=3e4,tt={current:null},_o={current:null},_l=Jc((e,o,n)=>T(void 0,null,function*(){if(n){let s=Math.floor(Date.now()/1e3);return{hash:yield n(),timestamp:s}}let{data:r}=yield Zc.default.get(`${e}/${mr}?from=${dl}&size=1&fields=hash,timestamp${o?"&shard="+o:""}`),[a]=r;return a}));function Qc(e,o,n,r){return T(this,null,function*(){if(e==null)throw new Error("missing api url");let a=Date.now();if(tt.current!=null&&a<tt.current.timestamp*1e3+ll&&!r)return tt.current;if(_o.current!=null)return yield _o.current;_o.current=_l(e,o,n);try{let s=yield _o.current;if(s==null)throw _o.current=null,new Error("could not get block hash");return tt.current={hash:s.hash,timestamp:s.timestamp},_o.current=null,s}catch(s){return _o.current=null,null}})}t();t();yn();t();t();var bp=A(Tp());var go=e=>{if(!e||!(0,bp.default)(e))return null;let o=e.split(".");if(o.length!==4)return null;try{let[n,r,a,s]=o,m=JSON.parse(lo(s)),d=lo(n);return{ttl:Number(a),extraInfo:m,origin:d,blockHash:r}}catch(n){return console.error(`Error trying to decode ${e}:`,n),null}};function Bl(e){return Object.prototype.toString.call(e)==="[object String]"}var wp=e=>{var n;if(!e||!Bl(e))return null;let o=e.split(".");if(o.length!==3)return console.error("Invalid nativeAuthToken. You may be trying to decode a loginToken. Try using decodeLoginToken method instead"),null;try{let[r,a,s]=o,m=lo(r),d=lo(a),l=go(d);if(!l)return{address:m,body:d,signature:s,blockHash:"",origin:"",ttl:0};let _=L(h({},l),{address:m,body:d,signature:s});return(n=l.extraInfo)!=null&&n.timestamp||delete _.extraInfo,_}catch(r){return null}};var hr={isExpired:!1},Sp=e=>{if(!e)return hr;let o=wp(e);if(!o)return hr;let n=Ao(),{ttl:r,extraInfo:a}=o,s=a==null?void 0:a.timestamp;if(!s)return hr;let m=s+r,d=n>m,l=m-n;return{isExpired:d,expiresAt:m,secondsUntilExpires:l}};t();Te();var nn={origin:U().origin,apiAddress:"https://api.multiversx.com",expirySeconds:60*60*24,tokenExpirationToastWarningSeconds:5*60},tn=e=>{var n,r,a,s,m,d;return e===!0?nn:{origin:(n=e==null?void 0:e.origin)!=null?n:nn.origin,blockHashShard:e==null?void 0:e.blockHashShard,expirySeconds:(r=e==null?void 0:e.expirySeconds)!=null?r:nn.expirySeconds,apiAddress:(a=e==null?void 0:e.apiAddress)!=null?a:nn.apiAddress,tokenExpirationToastWarningSeconds:(s=e==null?void 0:e.tokenExpirationToastWarningSeconds)!=null?s:nn.tokenExpirationToastWarningSeconds,extraInfo:(m=e==null?void 0:e.extraInfo)!=null?m:{},gatewayUrl:e==null?void 0:e.gatewayUrl,extraRequestHeaders:(d=e==null?void 0:e.extraRequestHeaders)!=null?d:{}}};var rn=e=>{let{origin:o,apiAddress:n,expirySeconds:r,blockHashShard:a,extraInfo:s,gatewayUrl:m,extraRequestHeaders:d}=tn(e),l=new vp.NativeAuthClient({origin:o,apiUrl:n,expirySeconds:r,blockHashShard:a,gatewayUrl:m,extraRequestHeaders:d});return{getNativeAuthConfig:tn,initialize:u=>T(void 0,null,function*(){var k,S;if(!n||!o)return"";let x=()=>l.getCurrentBlockHash();try{let b=(k=u==null?void 0:u.latestBlockInfo)!=null?k:yield Qc(n,a,x,u==null?void 0:u.noCache);if(!b)return"";let{hash:v,timestamp:I}=b,C=l.encodeValue(JSON.stringify(h(h({},(S=u==null?void 0:u.extraInfo)!=null?S:s),I?{timestamp:I}:{})));return`${l.encodeValue(o)}.${v}.${r}.${C}`}catch(b){return console.error("Error getting native auth token: ",b.toString()),""}}),getToken:({address:u,token:x,signature:k})=>l.getToken(u,x,k),getTokenExpiration:Sp}};var Ul=(e,o)=>{var n;return o?o===!0?e:(n=o.apiAddress)!=null?n:e:null},ne=e=>{let o=O(ve),n=O(Xo),r=(0,kp.useRef)(n==null?void 0:n.loginToken),a=Ul(o.apiAddress,e),s=tn(h(h({},e===!0?{}:e),a?{apiAddress:a}:{})),m=Boolean(e),d=rn(s),{address:l}=gr(),_=Z(),f=S=>{r.current=S,_(vn(h(L(h({},n),{loginToken:S}),a?{nativeAuthConfig:s}:{})))},u=()=>{try{return d.initialize()}catch(S){console.error("Unable to get block. Login failed.",S);return}},x=({address:S,signature:b})=>{let v=r.current;if(!v)throw"Token not found. Call `setLoginToken` first.";if(!m){_(vn({loginToken:v,signature:b}));return}let I=d.getToken({address:S,token:v,signature:b});return _(vn(h({loginToken:v,signature:b,nativeAuthToken:I},a?{nativeAuthConfig:s}:{}))),I};return{configuration:s,setLoginToken:f,getNativeAuthLoginToken:u,setTokenLoginInfo:x,refreshNativeAuthTokenLogin:v=>T(void 0,[v],function*({signMessageCallback:S,nativeAuthClientConfig:b}){let C=yield rn(b||s).initialize({noCache:Boolean(b)});if(r.current=C,!C)return;let N=new rt.Message({address:new rt.Address(l),data:i.Buffer.from(`${l}${C}`)}),E=yield S(N,{});if(!(E!=null&&E.signature))throw"Message not signed";return x({address:l,signature:i.Buffer.from(E.signature).toString("hex")})})}};var Ip=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r})=>{let[a,s]=(0,xr.useState)(""),[m,d]=(0,xr.useState)(!1),l=n!=null,_=ne(n),f=o,u=Z(),x=Q();function k(){return T(this,null,function*(){if(x)throw new Error(ee);fe(),d(!0);let b=Ap.ExtensionProvider.getInstance();try{if(!(yield b.init())){console.warn("Something went wrong trying to redirect to wallet login..");return}let I=to(),C=encodeURIComponent(Xe(e!=null?e:I));if(l&&!f&&(f=yield _.getNativeAuthLoginToken(),!f)){console.warn("Fetching block failed. Login cancelled.");return}f&&_.setLoginToken(f);let N=h({callbackUrl:C},f&&{token:f}),{signature:E,address:D}=yield b.login(N);if(le(b),!D){d(!1),console.warn("Login cancelled."),s("Login cancelled");return}E&&f&&_.setTokenLoginInfo({signature:E,address:D}),u(z({address:D,loginMethod:"extension"})),ae({callbackRoute:e,onLoginRedirect:r,options:{signature:E,address:D}})}catch(v){console.error("error logging in",v),s("error logging in"+v.message)}finally{d(!1)}})}let S=Boolean(a);return[k,{loginFailed:S,error:a,isLoading:m&&!S,isLoggedIn:x&&!S}]};t();var yr=require("react"),Lp=require("@multiversx/sdk-opera-provider");Ke();q();K();Ye();_e();Te();var Ep=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r})=>{let[a,s]=(0,yr.useState)(""),[m,d]=(0,yr.useState)(!1),l=n!=null,_=ne(n),f=o,u=Z(),x=Q();function k(){return T(this,null,function*(){if(x)throw new Error(ee);fe(),d(!0);let b=Lp.OperaProvider.getInstance();try{if(!(yield b.init())){console.warn("Something went wrong trying to redirect to wallet login..");return}let{origin:I}=U(),C=to(),N=encodeURIComponent(`${I}${e!=null?e:C}`);if(l&&!f&&(f=yield _.getNativeAuthLoginToken(),!f)){console.warn("Fetching block failed. Login cancelled.");return}f&&_.setLoginToken(f);let E=h({callbackUrl:N},f&&{token:f});yield b.login(E),le(b);let{signature:D,address:V}=b.account;if(!V){d(!1),console.warn("Login cancelled.");return}D&&f&&_.setTokenLoginInfo({signature:D,address:V}),u(z({address:V,loginMethod:"opera"})),ae({callbackRoute:e,onLoginRedirect:r,options:{signature:D,address:V}})}catch(v){console.error("error loging in",v),s("error logging in"+v.message)}finally{d(!1)}})}let S=Boolean(a);return[k,{loginFailed:S,error:a,isLoading:m&&!S,isLoggedIn:x&&!S}]};t();var kr=require("react");t();t();t();t();t();t();var Pp=require("@lifeomic/axios-fetch"),Tr=A(require("axios")),br=(0,Pp.buildAxiosFetch)(Tr.default),wr=(e,o)=>T(void 0,null,function*(){if(!e.ok)throw new Error(`HTTP error! Status: ${e.status}`);let r=e.clone().json(),[a]=yield Promise.all([r]);return{data:a,status:e.status,statusText:e.statusText,headers:e.headers,config:o}});function Wl(e,o,n){return T(this,null,function*(){try{let r=yield br(e,h({method:"POST",body:o?JSON.stringify(o):void 0,headers:h({"Content-Type":"application/json"},(n==null?void 0:n.headers)||{})},n));return wr(r,n)}catch(r){throw console.error("Fetch Error:",r),r}})}function Gl(e,o){return T(this,null,function*(){try{let n=yield br(e,o);if(!n.ok)throw new Error(`HTTP error! Status: ${n.status}`);return wr(n,o)}catch(n){throw console.error("Fetch Error:",n),n}})}function Vl(e,o,n){return T(this,null,function*(){try{let r=yield br(e,h({method:"PATCH",body:o?JSON.stringify(o):void 0,headers:(n==null?void 0:n.headers)||{}},n));if(!r.ok)throw new Error(`HTTP error! Status: ${r.status}`);return wr(r,n)}catch(r){throw console.error("Fetch Error:",r),r}})}var Do=Tr.default.create();Do.get=Gl;Do.post=Wl;Do.patch=Vl;t();var Sr=e=>{let o=e!=null?e:Pc(M.getState());return o.endsWith("/")?o.slice(0,-1):o};t();var Hl=A(require("axios"));t();var $l=A(require("swr"));var jl=e=>{let n=`${Sr()}/${Zn}/${e}?withGuardianInfo=true`;return Do.get(n)},Cp=e=>T(void 0,null,function*(){if(!e)return null;try{let{data:o}=yield jl(e);return o}catch(o){console.error("error fetching configuration for ",e,o)}return null});var at=e=>Cp(e);t();var Np=n=>T(void 0,[n],function*({loginToken:e,extraInfoData:o}){if(e==null||Object.keys(o).length===0)return null;let r=go(String(e)),_=(r==null?void 0:r.extraInfo)||{},{timestamp:a}=_,s=xo(_,["timestamp"]);if(!(r&&a!=null))return null;let d={hash:String(r==null?void 0:r.blockHash),timestamp:Number(a)};return yield rn({extraInfo:h(h({},s),o),expirySeconds:r==null?void 0:r.ttl,origin:r==null?void 0:r.origin}).initialize({latestBlockInfo:d})});var Rp=s=>T(void 0,[s],function*({loginToken:e,extraInfoData:o,address:n,signature:r,loginService:a}){let m=yield Np({loginToken:e,extraInfoData:o}),d=o.multisig||o.impersonate||n,l=m!=null?d:n;return m!=null&&a.setLoginToken(m),r&&a.setTokenLoginInfo({signature:r,address:n}),yield at(l)});Dt();Ke();Wo();q();ge();K();t();function vr(e){let o=M.getState(),n=Tc(o);return e?n&&!isNaN(n)?Math.max(n,e.nonce):e.nonce:n}Ye();Te();var Dp=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r,hasConsentPopup:a,walletAddress:s})=>{let[m,d]=(0,kr.useState)(""),[l,_]=(0,kr.useState)(!1),f=n!=null,u=ne(n),x=o,k=O(ve),S=Z(),b=Q();function v(){return T(this,null,function*(){if(b)throw new Error(ee);fe({skipLoginMethod:"crossWindow"}),_(!0);let C=yield no.CrossWindowProvider.getInstance().init(),N=no.CrossWindowProvider.getInstance().setWalletUrl(s!=null?s:k.walletAddress);try{if(!C){console.warn("Something went wrong trying to redirect to wallet login..");return}let{origin:E,pathname:D}=U(),V=encodeURIComponent(`${E}${e!=null?e:D}`);if(f&&!x&&(x=yield u.getNativeAuthLoginToken(),!x)){console.warn("Fetching block failed. Login cancelled.");return}x&&u.setLoginToken(x);let ke=h({callbackUrl:V},x&&{token:x});(Da&&f||a)&&N.setShouldShowConsentPopup(!0);let{signature:xe,address:Pe,multisig:R,impersonate:Ce}=yield N.login(ke);if(le(N),!Pe){_(!1),console.warn("Login cancelled.");return}let ce=yield Rp({loginToken:x,extraInfoData:{multisig:R,impersonate:Ce},address:Pe,signature:xe,loginService:u});if(!ce)return;S(z({address:ce.address,loginMethod:"crossWindow"})),S(ni(ce.address)),S(Ho(L(h({},ce),{nonce:vr(ce)}))),ae({callbackRoute:e,onLoginRedirect:r,options:{signature:xe,address:ce.address}})}catch(E){console.error("error loging in",E),d("error logging in"+E.message)}finally{_(!1)}})}let I=Boolean(m);return[v,{loginFailed:I,error:m,isLoading:l&&!I,isLoggedIn:b&&!I}]};t();var Ar=require("react");Ke();ge();t();t();t();Te();var Mp=()=>{let{search:e}=U(),o=new URLSearchParams(e),n=Object.fromEntries(o),r=n==null?void 0:n.address;return Yo(r)?r:null};t();t();function Op(){let e=ye();return Le(e)}t();K();t();function an(e){return Op()===e}function it(){let e=M.getState(),o=ye(),n=Ko(e),r=No(e),a=Sc(e);if(!o)throw"provider not initialized";return an("ledger")&&r?new Promise(s=>{s(n)}):!an("")&&!an("wallet")&&!an("extra")?o.getAddress():new Promise(s=>{let m=Mp();a!=null&&m&&s(m),r&&s(n),s("")})}t();t();Te();var Fp=()=>{let{search:e}=U(),o=new URLSearchParams(e),n=Object.fromEntries(o);return n==null?void 0:n.accessToken};var Bp=()=>{var n;let e=Fp(),o=ie(M.getState());return e!=null?e:(n=o.webviewLogin)==null?void 0:n.data};t();q();re();t();ge();t();ge();t();var Up=require("@multiversx/sdk-core");re();_e();t();Ut();t();t();var zl=A(require("platform"));Eo();t();So();q();re();t();function Wp(e,o){if(!e){typeof console!="undefined"&&console.warn(o);try{throw new Error(o)}catch(n){}}}function Gp(e,o){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[n,r]=ql(e.path,e.caseSensitive,e.end),a=o.match(n);if(!a)return null;let s=a[0],m=s.replace(/(.)\/+$/,"$1"),d=a.slice(1);return{params:r.reduce((_,f,u)=>{if(f==="*"){let x=d[u]||"";m=s.slice(0,s.length-x.length).replace(/(.)\/+$/,"$1")}return _[f]=Kl(d[u]||"",f),_},{}),pathname:s,pathnameBase:m,pattern:e}}function ql(e,o=!1,n=!0){Wp(e==="*"||!e.endsWith("*")||e.endsWith("/*"),`Route path "${e}" will be treated as if it were "${e.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${e.replace(/\*$/,"/*")}".`);let r=[],a="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^$?{}|()[\]]/g,"\\$&").replace(/:(\w+)/g,(m,d)=>(r.push(d),"([^\\/]+)"));return e.endsWith("*")?(r.push("*"),a+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):a+=n?"\\/*$":"(?:(?=[.~-]|%[0-9A-F]{2})|\\b|\\/|$)",[new RegExp(a,o?void 0:"i"),r]}function Kl(e,o){try{return decodeURIComponent(e)}catch(n){return Wp(!1,`The value for the URL param "${o}" will not be decoded because the string "${e}" is a malformed URL segment. This is probably due to a bad percent encoding (${n}).`),e}}Pn();Lo();Io();_e();var Vp=({callbackUrl:e,onRedirect:o})=>{typeof o=="function"?o(e):e&&En({url:e})},Xl=e=>{let o=Ue.local.getItem(Ee.logoutEvent),{data:n}=o?JSON.parse(o):{data:e};e===n&&(Ue.local.setItem({key:Ee.logoutEvent,data:e,expires:0}),Ue.local.removeItem(Ee.logoutEvent))},Yl=500;function Hp(a,s){return T(this,arguments,function*(e,o,n=Boolean(Bp()),r={shouldBroadcastLogoutAcrossTabs:!0,hasConsentPopup:!1}){var b,v,I;let m=yield it(),d=ye(),l=Le(d),_=l==="wallet",f=((b=d==null?void 0:d.isInitialized)==null?void 0:b.call(d))===!0;if(n&&(d==null?void 0:d.relogin)!=null)return d.relogin();m&&r.shouldBroadcastLogoutAcrossTabs&&Xl(m);let u=Xe(e),x=U(),{pathname:k,origin:S}=new URL(decodeURIComponent(u));if((Gp(x.pathname,k)||_&&f||((v=de.safeWindow)==null?void 0:v.opener)&&S===((I=de.safeWindow)==null?void 0:I.origin))&&yi(),!m&&!f)return Vp({callbackUrl:u,onRedirect:o});try{if(M.dispatch(H()),_)return setTimeout(()=>{d.logout({callbackUrl:u})},Yl);r.hasConsentPopup&&l==="crossWindow"&&d.setShouldShowConsentPopup(!0),yield d.logout({callbackUrl:u})}catch(C){console.error("Logging out error:",C)}finally{_||Vp({callbackUrl:u,onRedirect:o})}})}t();t();t();t();t();t();t();So();K();t();t();var Jl=require("@multiversx/sdk-metamask-provider/out/metamaskProvider");t();t();Pn();Lo();t();t();t();ge();t();t();var Zl=A(require("axios"));_e();t();t();var Xp=A(jp());So();var zp,qp,Kp,e_=(Kp=(qp=(zp=de.safeWindow)==null?void 0:zp.location)==null?void 0:qp.origin)==null?void 0:Kp.includes("localhost"),Yp=e=>{if(!(0,Xp.default)(e))return Boolean(e);let n=h({},e);return Boolean(e_)&&delete n.origin,Object.keys(n).length>0};t();var Jp=({maxRetries:e})=>new Promise((o,n)=>{let r=0,a=()=>{let s=cr(M.getState());if(s){o(s);return}if(r<e){r++,setTimeout(a,1e3);return}n(null)};a()});Te();t();var Zp=(e,o=["address"])=>{let n=new URL(e),r=new URLSearchParams(n.search);o.forEach(m=>r.delete(m));let a=Array.from(r.values()).length>0?"?":"",s=n.pathname==="/"&&!e.endsWith("/")?"":n.pathname;return n.protocol==="vscode:"?e:`${n.origin}${s}${a}${r.toString()}${n.hash}`};var ct=({callbackRoute:e,token:o,nativeAuth:n,redirectDelayMilliseconds:r=100,customWalletAddress:a})=>{let[s,m]=(0,Ar.useState)(""),[d,l]=(0,Ar.useState)(!1),_=O(ve),f=Z(),u=Q(),x=Boolean(n),k=ne(n),S=o;function b(){return T(this,null,function*(){if(u)throw new Error(ee);f(Pi(a));try{l(!0);let I=Ha(a!=null?a:_.walletAddress),C=new Date,N=C.setMinutes(C.getMinutes()+3)/1e3,E={data:{},expires:N};if(x&&!S&&(S=yield k.getNativeAuthLoginToken(),!S)){console.warn("Login cancelled.");return}S&&k.setLoginToken(S);let{origin:D}=U(),V=window!=null&&window.location?`${D}${e}`:`${e}`;new URLSearchParams(document==null?void 0:document.location.search).get("address")||f(si(E));let xe=Zp(V),Pe=encodeURIComponent(xe),R=L(h({callbackUrl:Pe},S&&{token:S}),{redirectDelayMilliseconds:r});yield I.login(R)}catch(I){console.error(I),m("error logging in"+I.message)}finally{l(!1)}})}let v=Boolean(s);return[b,{error:s,loginFailed:v,isLoading:d&&!v,isLoggedIn:u&&!v}]};t();var gs=require("react");F();t();t();F();var Qp=e=>{var a;let o=O(Xo),n=(a=o==null?void 0:o.loginToken)!=null?a:e;if(!n)return;let r=go(n);if(!!r)return r.origin.toLowerCase().startsWith(Ea)};t();t();t();var o_=A(require("bignumber.js"));t();t();t();var ao=A(require("react")),ms=require("react"),ds=require("react"),Dr=A(require("classnames")),ls=require("react-dom");F();t();var ts=A(require("react"));t();var cn=A(require("react"));t();Eo();var es=()=>!so();var t_=()=>T(void 0,null,function*(){return yield Promise.resolve().then(()=>(Lr(),Ir))}),r_=()=>(Lr(),Re(Ir)).default,Er=es();function ns({ssrGlobalImportCallback:e,ssrImportCallback:o,clientImportCallback:n}){let[r,a]=cn.default.useState(Er?void 0:r_()),[s,m]=cn.default.useState(Er||n==null?void 0:n()),d=()=>T(this,null,function*(){(e?e():t_()).then(l=>a(l.default)),o==null||o().then(l=>m(l.default))});return(0,cn.useEffect)(()=>{Er&&d()},[]),{globalStyles:r,styles:s}}function ro(e,o){return n=>{let{globalStyles:r,styles:a}=ns({ssrGlobalImportCallback:o.ssrGlobalStyles,ssrImportCallback:o.ssrStyles,clientImportCallback:o.clientStyles});return ts.default.createElement(e,L(h({},n),{globalStyles:r!=null?r:{},styles:a!=null?a:{}}))}}t();var as=A(require("react")),is=A(require("classnames"));var i_=({className:e,children:o,styles:n})=>as.default.createElement("div",{className:(0,is.default)(n==null?void 0:n.dappModalBody,e)},o),Pr=ro(i_,{ssrStyles:()=>Promise.resolve().then(()=>(oo(),eo)),clientStyles:()=>(oo(),Re(eo)).default});t();var Cr=A(require("react")),cs=A(require("classnames"));var c_=({visible:e,customFooter:o,className:n,footerText:r,styles:a})=>e?Cr.default.createElement("div",{className:(0,cs.default)(a==null?void 0:a.dappModalFooter,n)},o!=null?o:Cr.default.createElement("div",null,r)):null,Nr=ro(c_,{ssrStyles:()=>Promise.resolve().then(()=>(oo(),eo)),clientStyles:()=>(oo(),Re(eo)).default});t();var Mo=A(require("react")),ps=require("@fortawesome/free-solid-svg-icons"),ss=require("@fortawesome/react-fontawesome"),pn=A(require("classnames"));var p_=({visible:e,headerText:o,customHeader:n,className:r,closeButtonClassName:a,headerTextClassName:s,onHide:m,globalStyles:d,styles:l})=>e?n?Mo.default.createElement("div",{className:(0,pn.default)(l==null?void 0:l.dappModalHeader,r)},n):Mo.default.createElement("div",{className:(0,pn.default)(l==null?void 0:l.dappModalHeader,r)},Mo.default.createElement("div",{className:(0,pn.default)(l==null?void 0:l.dappModalHeaderText,s)},o),Mo.default.createElement("button",{onClick:m,className:(0,pn.default)(l==null?void 0:l.dappModalCloseButton,d==null?void 0:d.btn,d==null?void 0:d.btnLight,a)},Mo.default.createElement(ss.FontAwesomeIcon,{size:"lg",icon:ps.faTimes}))):null,Rr=ro(p_,{ssrStyles:()=>Promise.resolve().then(()=>(oo(),eo)),clientStyles:()=>(oo(),Re(eo)).default});var s_={showHeader:!0,showFooter:!1,headerText:"",footerText:""},m_=({"data-testid":e="dappModal",children:o,className:n="dapp-modal-dialog-wrapper",closeOnEscape:r,config:a=s_,id:s="dapp-modal",onHide:m,parentElement:d,visible:l,styles:_})=>{let[f,u]=(0,ms.useState)(!1);if((0,ds.useEffect)(()=>{u(!0)},[]),!l)return null;let{showHeader:x,showFooter:k,headerText:S,footerText:b,modalDialogClassName:v="dapp-modal-dialog",modalContentClassName:I="dapp-modal-dialog-content",modalHeaderClassName:C="dapp-modal-dialog-header",modalHeaderTextClassName:N="dapp-modal-dialog-header-text",modalCloseButtonClassName:E="dapp-modal-dialog-close-button",modalBodyClassName:D="dapp-modal-dialog-content-body",modalFooterClassName:V="dapp-modal-dialog-footer",customModalHeader:ke,customModalFooter:Ve}=a,xe=Pe=>{Pe.key==="Escape"&&r&&(m==null||m())};return ao.default.createElement(ao.default.Fragment,null,f&&(0,ls.createPortal)(ao.default.createElement("div",{id:s,role:"dialog","aria-modal":"true",className:(0,Dr.default)(v,_==null?void 0:_.dappModal,n),"data-testid":e,onKeyDown:xe},ao.default.createElement("div",{className:(0,Dr.default)(_==null?void 0:_.dappModalContent,I)},ao.default.createElement(Rr,{visible:x,headerText:S,customHeader:ke,className:C,headerTextClassName:N,closeButtonClassName:E,onHide:m}),ao.default.createElement(Pr,{className:D},o),ao.default.createElement(Nr,{visible:k,customFooter:Ve,footerText:b,className:V}))),d!=null?d:document==null?void 0:document.body))},d_=ro(m_,{ssrStyles:()=>Promise.resolve().then(()=>(oo(),eo)),clientStyles:()=>(oo(),Re(eo)).default});t();t();var pt=require("react"),_s=e=>{let[o,n]=(0,pt.useState)(!1),r=()=>{n(!0)},a=()=>{n(!1)};return(0,pt.useEffect)(()=>{(e==null?void 0:e.visible)===!0?r():(e==null?void 0:e.visible)===!1&&a()},[e==null?void 0:e.visible]),{handleShowModal:r,handleHideModal:a,showModal:o}};t();var us=({hideButtonWhenModalOpens:e,onContentHide:o,onContentShow:n,onModalCloses:r,onModalOpens:a,token:s,wrapContentInsideModal:m})=>{let d=Kc(),[l,_]=(0,gs.useState)(!1),{handleShowModal:f,handleHideModal:u,showModal:x}=_s(),k=Qp(s),S=!e||!l,b=()=>{_(!1),o==null||o(),m?(u(),r==null||r()):r&&(console.warn('Deprecated: "onModalCloses" must be used only when "wrapContentInsideModal" is set to "true". Use "onContentHide" instead.'),r())};return{disabledConnectButton:k,handleCloseModal:b,handleOpenModal:()=>{if(d)throw new Error(ee);if(l)return b();_(!0),n==null||n(),m?(f(),a==null||a()):a&&(console.warn('Deprecated: "onModalOpens" must be used only when "wrapContentInsideModal" is set to "true". Use "onContentShow" instead.'),a())},shouldRenderButton:S,showContent:l,showModal:x}};t();var Oo=require("react"),Mr=require("@multiversx/sdk-hw-provider");Ke();q();ge();K();Ye();t();var uo=require("react"),l_=10,fs=()=>{let[e,o]=(0,uo.useState)(""),[n,r]=(0,uo.useState)(!1),[a,s]=(0,uo.useState)(0),[m,d]=(0,uo.useState)([]),[l,_]=(0,uo.useState)(null),[f,u]=(0,uo.useState)(!1);return{accounts:m,defaultAddressesPerPage:l_,error:e,isLoading:n,onGoToNextPage:()=>{_(null),s(v=>v+1)},onGoToPrevPage:()=>{_(null),s(v=>v===0?0:v-1)},onGoToSpecificPage:v=>{_(null),s(v)},onSelectAddress:v=>{_(v)},selectedAddress:l,setAccounts:d,setError:o,setIsLoading:r,setShowAddressList:u,showAddressList:f,startIndex:a}};var sn="Check if the MultiversX App is open on Ledger",hs=({callbackRoute:e,token:o,addressesPerPage:n,nativeAuth:r,onLoginRedirect:a})=>{let s=O(bc),m=ye(),d=Z(),l=Q(),_=r!=null,f=ne(r),u=o,{accounts:x,setAccounts:k,isLoading:S,setIsLoading:b,setShowAddressList:v,showAddressList:I,startIndex:C,selectedAddress:N,onGoToPrevPage:E,onGoToNextPage:D,onGoToSpecificPage:V,onSelectAddress:ke,error:Ve,setError:xe,defaultAddressesPerPage:Pe}=fs(),R=n!=null?n:Pe,[Ce,ce]=(0,Oo.useState)(""),[Fo,fo]=(0,Oo.useState)(!1),mn=({address:B,index:W,signature:P})=>{d(pi({index:W,loginType:"ledger"})),P&&f.setTokenLoginInfo({signature:P,address:B}),d(z({address:B,loginMethod:"ledger"})),ae({callbackRoute:e,onLoginRedirect:a,options:{address:B,signature:P}})},X=(B,W="")=>{var P;if(S){let{errorMessage:G,defaultErrorMessage:$}=vi(B),Y=(P=G!=null?G:$)!=null?P:sn;xe(`${Y}.${W}`),b(!1),d(jt(null))}},Ne=()=>T(void 0,null,function*(){try{if(m instanceof Mr.HWProvider&&m.isInitialized())return m.isConnected()}catch(B){X(B)}return!1}),mt=()=>T(void 0,null,function*(){if(yield Ne()){xe(""),b(!1);return}try{let W=new Mr.HWProvider;(yield W.init())&&le(W),xe(""),b(!1)}catch(W){X(W)}}),dt=()=>T(void 0,null,function*(){let B=yield Ne();if(!N||!B)return X(sn);let{index:W}=N;if(_&&!u&&(u=yield f.getNativeAuthLoginToken(),!u)){console.warn("Fetching block failed. Login cancelled.");return}if(u){f.setLoginToken(u);try{let P=yield m.tokenLogin({token:i.Buffer.from(`${u}{}`),addressIndex:W});mn({address:P.address,index:W,signature:P.signature.toString("hex")})}catch(P){X(P,". Update MultiversX App to continue.")}}else try{let{address:P}=yield m.login({addressIndex:W});mn({address:P,index:W})}catch(P){return X(P),!1}return!0}),lt=()=>T(void 0,null,function*(){try{if(b(!0),N==null)return!1;d(s?ti(N):jt(L(h({},N),{version:Ce,hasContractDataEnabled:Fo}))),b(!1),yield dt()}catch(B){X(B)}return v(!1),!0}),Bo=()=>T(void 0,null,function*(){if(!(yield Ne()))return X(Ve);try{b(!0);let W=yield m.getAccounts(C,R),P=yield $a(m);ce(P.version),fo(P.dataEnabled),k(W),b(!1)}catch(W){X(W)}}),_t=()=>T(void 0,null,function*(){if(l)throw new Error(ee);fe(),xe("");try{if(b(!0),!(yield Ne()))return X(sn);if(s!=null){if(!N)return X(sn);let{address:W}=yield m.login({addressIndex:N.index.valueOf()});if(!W)return X("Login cancelled.");d(z({address:W,loginMethod:"ledger"})),ae({callbackRoute:e,onLoginRedirect:a})}else x!=null&&x.length||(yield Bo()),v(!0);b(!1)}catch(B){X(B)}}),gt=()=>T(void 0,null,function*(){try{let B=yield Ne();if(B||(yield mt()),B=yield Ne(),!B)return X(sn);(x.length===0||C>=0)&&(yield Bo())}catch(B){X(B)}});(0,Oo.useEffect)(()=>{gt()},[C,I,m]),(0,Oo.useEffect)(()=>{(x==null?void 0:x.length)>0&&!I&&v(!0)},[x]);let He=Boolean(Ve);return[_t,{loginFailed:He,isLoggedIn:l&&!He,error:Ve,isLoading:S&&!He},{accounts:x,showAddressList:I,startIndex:C,selectedAddress:N,version:Ce,contractDataEnabled:Fo,onGoToPrevPage:E,onGoToNextPage:D,onGoToSpecificPage:V,onSelectAddress:ke,onConfirmSelectedAddress:lt}]};t();var xs=e=>{var n;let o=O(Nc);return ct(L(h({},e),{customWalletAddress:(n=e.customWalletAddress)!=null?n:o}))};t();var he=require("react");t();var st=require("react");function ys(e,o=[]){let n=(0,st.useRef)(!0);(0,st.useEffect)(()=>{n.current?n.current=!1:e()},o)}q();ge();K();Ye();Te();var Ts=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r,logoutRoute:a,customRequestMethods:s=[]})=>{var W;let m=Z(),d=Yp(n),l=ne(d?n:!1),_=o,[f,u]=(0,he.useState)(""),[x,k]=(0,he.useState)(""),[S,b]=(0,he.useState)(!0),[v,I]=(0,he.useState)([]),[C,N]=(0,he.useState)(null),{provider:E}=jc(),D=O(Ac),V=O(Ic),ke=O(Lc),Ve=O(Ec),xe=O(vc),Pe=O(wc),R=(0,he.useRef)(E),Ce=(0,he.useRef)(!1),ce=(0,he.useRef)(!1),Fo=(W=a!=null?a:xe)!=null?W:"/",fo=[hn.CANCEL_ACTION,...s];o&&fo.push(hn.SIGN_LOGIN_TOKEN),d&&fo.push(hn.SIGN_NATIVE_AUTH_TOKEN);let mn=S?"":`${Ve}?wallet-connect=${encodeURIComponent(x)}`,X=Boolean(f),Ne=Q(),mt=()=>{Hp(Fo)},dt=P=>{console.log("WalletConnect Session Event: ",P)},lt=()=>T(void 0,null,function*(){var P,G,$,Y;try{if(Ce.current||R.current==null)return;if(!ce.current){try{yield(P=R.current)==null?void 0:P.logout()}catch(ut){console.warn("Unable to logout")}return}let te=yield($=(G=R.current)==null?void 0:G.getAddress)==null?void 0:$.call(G);if(!te){console.warn("Login cancelled.");return}let Ae=yield(Y=R.current)==null?void 0:Y.getSignature(),be={address:te,loginMethod:"walletconnectv2"},ho={logoutRoute:Fo,loginType:"walletconnectv2",callbackRoute:e!=null?e:U().href};m(ci(ho)),Ae&&l.setTokenLoginInfo({signature:Ae,address:te}),m(z(be)),ae({callbackRoute:e,onLoginRedirect:r,options:{address:te,signature:Ae}})}catch(te){u("User rejected connection proposal"),console.error(te)}}),Bo=()=>T(void 0,null,function*(){var G,$,Y,te,Ae;if(Le(R.current)==="walletconnectv2")try{((te=(Y=($=(G=R.current)==null?void 0:G.walletConnector)==null?void 0:$.session)==null?void 0:Y.getAll())!=null?te:[]).length>0&&(yield(Ae=R.current)==null?void 0:Ae.logout()),R.current=Vo,N(null)}catch(be){console.warn("Unable to logout")}}),_t=P=>T(void 0,null,function*(){var G,$,Y;if(!D||!V){u("Invalid WalletConnect setup");return}if(!P||!P.topic){u("Expired connection");return}try{if((R.current?Le(R.current):!1)!=="walletconnectv2"){yield He();return}if(b(!0),yield Bo(),d&&!_&&(_=yield l.getNativeAuthLoginToken(),!_)){console.warn("Fetching block failed. Login cancelled.");return}_&&l.setLoginToken(_),yield He(!1);let{approval:Ae}=yield(G=R.current)==null?void 0:G.connect({topic:P.topic,methods:fo});try{yield($=R.current)==null?void 0:$.login({approval:Ae,token:_})}catch(be){console.error("User rejected existing connection proposal",be),u("User rejected existing connection proposal"),b(!0),yield He()}}catch(te){console.error("Unable to connect to existing session",te),u("Unable to connect to existing session")}finally{I((Y=R.current)==null?void 0:Y.pairings)}}),gt=P=>T(void 0,null,function*(){var G,$;try{P&&(yield(G=R.current)==null?void 0:G.logout({topic:P}))}catch(Y){console.error("Unable to remove existing pairing",Y),u("Unable to remove existing pairing")}finally{let Y=yield($=R.current)==null?void 0:$.getPairings();I(Y)}});function He(P=!0){return T(this,null,function*(){var ho,ut,Ur;fe();let G=yield Jp({maxRetries:15});if(!G){console.error("Invalid chainID"),u("Invalid chainID");return}if(!V||!D){console.error("Invalid WalletConnect setup"),u("Invalid WalletConnect setup");return}let $=Q(),Y=ce.current===!1&&!$,te=(ut=(ho=R.current)==null?void 0:ho.isInitialized)==null?void 0:ut.call(ho);if(Ce.current||Y||te)return;if(Ce.current=!0,(Ur=R.current)!=null&&Ur.walletConnector){yield R.current.init(),N(R.current),Ce.current=!1,P&&(yield B());return}let Ae={onClientLogin:lt,onClientLogout:mt,onClientEvent:dt},be=new xn(Ae,G,D,V,ke);yield be.init(),N(be),R.current=be,Ce.current=!1,P&&(I(be.pairings),yield B())})}function B(){return T(this,null,function*(){var P,G;if(!!R.current){if(!D||!V){u("Invalid WalletConnect setup");return}try{if(!ce.current)return;let{uri:$,approval:Y}=yield(P=R.current)==null?void 0:P.connect({methods:fo});if(!Boolean($))return;if(k($),(ke==null?void 0:ke.logger)==="debug"&&console.log("WalletConnect uri: ",$),d&&!_&&(_=yield l.getNativeAuthLoginToken(),!_)){console.warn("Fetching block failed. Login cancelled.");return}if(_&&l.setLoginToken(_),(R.current?Le(R.current):!1)!=="walletconnectv2"){b(!0),yield He();return}try{yield(G=R.current)==null?void 0:G.login({approval:Y,token:_})}catch(be){console.error("User rejected connection proposal",be),u("User rejected connection proposal"),b(!0)}}catch($){console.error("Unable to connect",$)}}})}return ys(()=>{R.current=E},[E]),(0,he.useEffect)(()=>(ce.current=!0,()=>{ce.current=!1}),[]),(0,he.useEffect)(()=>{b(!x)},[x]),(0,he.useEffect)(()=>{if(!C)return;(Boolean(C.session)||Pe==="walletconnectv2")&&Ne&&le(C)},[C,Ne]),[He,{error:f,loginFailed:X,isLoading:S&&!X,isLoggedIn:Ne&&!X},{uriDeepLink:mn,walletConnectUri:x,cancelLogin:Bo,connectExisting:_t,removeExistingPairing:gt,wcPairings:v}]};t();var Or=require("react"),bs=require("@multiversx/sdk-metamask-provider/out/metamaskProvider");Ke();q();K();Ye();_e();_e();var ws=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r})=>{let[a,s]=(0,Or.useState)(""),[m,d]=(0,Or.useState)(!1),l=n!=null,_=ne(n),f=o,u=Z(),x=Q();function k(){return T(this,null,function*(){if(x)throw new Error(ee);fe(),d(!0);let b=bs.MetamaskProvider.getInstance();try{if(!(yield b.init())){console.warn("Something went wrong trying to redirect to wallet login..");return}let I=to(),C=encodeURIComponent(Xe(e!=null?e:I));if(l&&!f&&(f=yield _.getNativeAuthLoginToken(),!f)){console.warn("Fetching block failed. Login cancelled.");return}f&&_.setLoginToken(f);let N=h({callbackUrl:C},f&&{token:f});yield b.login(N),le(b);let{signature:E,address:D}=b.account;if(!D){d(!1),console.warn("Login cancelled."),s("Login cancelled");return}E&&f&&_.setTokenLoginInfo({signature:E,address:D}),u(z({address:D,loginMethod:"metamask"})),ae({callbackRoute:e,onLoginRedirect:r,options:{signature:E,address:D}})}catch(v){console.error("error logging in",v),s("error logging in"+v.message)}finally{d(!1)}})}let S=Boolean(a);return[k,{loginFailed:S,error:a,isLoading:m&&!S,isLoggedIn:x&&!S}]};t();var Fr=require("react"),Br=require("@multiversx/sdk-passkey-provider/out");Ke();q();K();Ye();_e();_e();var Ss=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r})=>{let[a,s]=(0,Fr.useState)(""),[m,d]=(0,Fr.useState)(!1),l=n!=null,_=ne(n),f=o,u=Z(),x=Q();function k(){return T(this,null,function*(){if(x)throw new Error(ee);fe(),d(!0);let v=Br.PasskeyProvider.getInstance();try{if(!(yield v.init())){console.warn("Something went wrong trying to redirect to wallet login..");return}let C=to(),N=encodeURIComponent(Xe(e!=null?e:C));if(l&&!f&&(f=yield _.getNativeAuthLoginToken(),!f)){console.warn("Fetching block failed. Login cancelled.");return}f&&_.setLoginToken(f);let E=h({callbackUrl:N},f&&{token:f});yield v.login(E),le(v);let{signature:D,address:V}=v.account;if(!V){d(!1),console.warn("Login cancelled."),s("Login cancelled");return}D&&f&&_.setTokenLoginInfo({signature:D,address:V}),u(z({address:V,loginMethod:"passkey"})),ae({callbackRoute:e,onLoginRedirect:r,options:{signature:D,address:V}})}catch(I){console.error("error logging in",I),s("Error logging in: "+I.message)}finally{d(!1)}})}let S=v=>T(void 0,null,function*(){let I=Br.PasskeyProvider.getInstance();return yield I.init(),yield I.createAccount({walletName:v})}),b=Boolean(a);return[k,S,{loginFailed:b,error:a,isLoading:m&&!b,isLoggedIn:x&&!b}]};0&&(module.exports={useCrossWindowLogin,useExtensionLogin,useGetModalLoginMethods,useLedgerLogin,useMetamaskLogin,useOperaLogin,usePasskeyLogin,useWalletConnectV2Login,useWebWalletLogin,useXaliasLogin});
/*!
