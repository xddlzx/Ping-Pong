...
.dapp-core-component__dappModalStyles__dappModalCloseButton:focus {
  ...
  border-color: #e9ecef;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(q_));Xy={dappModal:"dapp-core-component__dappModalStyles__dappModal",dappModalContent:"dapp-core-component__dappModalStyles__dappModalContent",dappModalHeader:"dapp-core-component__dappModalStyles__dappModalHeader",dappModalHeaderText:"dapp-core-component__dappModalStyles__dappModalHeaderText",dappModalBody:"dapp-core-component__dappModalStyles__dappModalBody",dappModalFooter:"dapp-core-component__dappModalStyles__dappModalFooter",dappModalCloseButton:"dapp-core-component__dappModalStyles__dappModalCloseButton"}});var dS={};_o(dS,{useCheckTransactionStatus:()=>lh,useCrossWindowLogin:()=>N_,useDebounce:()=>Wy,useExtensionLogin:()=>E_,useGetAccount:()=>lo,useGetAccountInfo:()=>bi,useGetAccountProvider:()=>Je,useGetActiveTransactionsStatus:()=>_h,useGetBatchWebsocketEvent:()=>wi,useGetEgldPrice:()=>mS,useGetFailedTransactions:()=>uh,useGetIsLoggedIn:()=>Ai,useGetIsWalletConnectV2Initialized:()=>Ny,useGetLastPendingTransactionHash:()=>gh,useGetLoginInfo:()=>Ii,useGetModalLoginMethods:()=>tu,useGetNetworkConfig:()=>Jn,useGetNotification:()=>Zf,useGetPendingTransactions:()=>Zn,useGetPollingInterval:()=>hh,useGetSignTransactionsError:()=>Th,useGetSignedTransactions:()=>ot,useGetSuccessfulTransactions:()=>xh,useGetToasts:()=>fu,useGetTokenDetails:()=>yh,useGetTransactionDisplayInfo:()=>Sh,useGetWebsocketEvent:()=>ki,useGetWebsocketUrl:()=>tS,useLedgerLogin:()=>au,useMetamaskLogin:()=>pu,useOperaLogin:()=>C_,useParseMultiEsdtTransferData:()=>di,useParseSignedTransactions:()=>tt,usePasskeyLogin:()=>mu,useRegisterWebsocketListener:()=>pS,useSignMultipleTransactions:()=>Ti,useSignTransactions:()=>Fy,useSignTransactionsCommonData:()=>ut,useSignTransactionsWithDevice:()=>Di,useSignTransactionsWithLedger:()=>Uy,useTrackTransactionStatus:()=>By,useTransactionsToasts:()=>gu,useUpdateEffect:()=>ni,useWalletConnectV2Login:()=>su,useWebWalletLogin:()=>Kr,useXaliasLogin:()=>iu});module.exports=Ze(dS);t();t();t();var Lp=require("react"),bn=require("react-redux");t();var Fa=require("@reduxjs/toolkit"),Ap=require("react-redux/lib/utils/Subscription");ee();t();var sp=C(require("lodash.throttle"));j();ee();Ia();_n();ln();var qg=[Pt],or=!1,zg=(0,sp.default)(()=>{Bn(Un())},5e3),cp=e=>o=>n=>{if(qg.includes(n.type))return o(n);let r=e.getState(),a=io.local.getItem(Ke.loginExpiresAt);if(!Boolean(r==null?void 0:r.account.address))return o(n);if(a==null)return Bn(Un());let m=Date.now();return a-m<0&&!or?setTimeout(()=>{or=!0,e.dispatch(Sc())},1e3):(or&&(or=!1),zg()),o(n)};t();t();function nr(){return typeof sessionStorage!="undefined"}var wp=nr()?(up(),Ze(_p)).default:(fp(),Ze(gp)).default,vp=nr()?(Tp(),Ze(hp)).default:[],Ip=nr()?(bp(),Ze(Sp)).default:e=>e;tr();var P=(0,Fa.configureStore)({reducer:wp,middleware:e=>e({serializableCheck:{ignoredActions:[...vp,wa.type,un.type],ignoredPaths:["payload.nonce","account.account.nonce","providers.accountProvider"]}}).concat(cp)}),kp=(0,Ap.createSubscription)(P),uv=Ip(P),gv=(0,Fa.configureStore)({reducer:jo});var hf={store:P,subscription:kp},Ua=(0,Lp.createContext)(hf),xv=(0,bn.createStoreHook)(Ua),K=(0,bn.createDispatchHook)(Ua),w=(0,bn.createSelectorHook)(Ua);t();t();ee();t();var Ep=C(require("lodash.isequal")),rr=require("reselect"),L=(0,rr.createSelectorCreator)(rr.defaultMemoize,Ep.default);var po=e=>e.account,wo=L(po,e=>e.address),qo=L(po,wo,(e,o)=>o in e.accounts?e.accounts[o]:Rt),Pp=L(po,qo,(e,o)=>{let a=e,{accounts:n}=a,r=Eo(a,["accounts"]);return D(h({},r),{address:o.address,account:o})}),vv=L(qo,e=>e.balance),Cp=L(qo,e=>{var o;return((o=e==null?void 0:e.nonce)==null?void 0:o.valueOf())||0}),Iv=L(po,e=>e.shard),Np=L(po,e=>e.ledgerAccount),Av=L(po,e=>e.walletConnectAccount),kv=L(po,e=>e.isAccountLoading),Lv=L(po,e=>e.accountLoadingError),Rp=L(po,e=>e.websocketEvent),Dp=L(po,e=>e.websocketBatchEvent);t();var Ba=e=>e.dappConfig,Cv=L(Ba,e=>e.shouldUseWebViewProvider);t();var Pe=e=>e.loginInfo,Mp=L(Pe,e=>e.loginMethod),Mo=L(Pe,wo,(e,o)=>Boolean(o)),Mv=L(Pe,e=>e.walletConnectLogin),Op=L(Pe,e=>e.ledgerLogin),Fp=L(Pe,e=>e.walletLogin),Ov=L(Pe,e=>e.isLoginSessionInvalid),Vn=L(Pe,e=>e.tokenLogin),ar=L(Pe,e=>e.logoutRoute),Up=L(Pe,e=>e.isWalletConnectV2Initialized);t();var Bp=e=>e.modals,Bv=L(Bp,e=>e.txSubmittedModal),Wp=L(Bp,e=>e.notificationModal);t();var qe=e=>e.networkConfig,$n=L(qe,e=>e.network.chainId),Gp=L(qe,e=>e.network.roundDuration),Hv=L(qe,e=>e.network.walletConnectBridgeAddress),Hp=L(qe,e=>e.network.walletConnectV2RelayAddress),Vp=L(qe,e=>e.network.walletConnectV2ProjectId),$p=L(qe,e=>e.network.walletConnectV2Options),jp=L(qe,e=>e.network.walletConnectDeepLink),xe=L(qe,e=>e.network),ir=L(xe,e=>e.apiAddress),qp=L(xe,e=>e.explorerAddress),sr=L(xe,e=>{var o;return(o=e.customWalletAddress)!=null?o:e.walletAddress}),zp=L(xe,e=>e.xAliasAddress),Wa=L(xe,e=>e.egldLabel);t();var cr=e=>e.signedMessageInfo,jv=L(cr,e=>e.isSigning),qv=L(cr,e=>e.errorMessage),zv=L(cr,e=>{let o=Object.keys(e.signedSessions),n=o.length;return e.signedSessions[o[n-1]]}),Kv=L(cr,e=>{let o=Object.keys(e.signedSessions),n=o.length;return o.length>0?o[n-1]:""});t();var Kp=e=>e.toasts,Xp=L(Kp,e=>e.customToasts),pr=L(Kp,e=>e.transactionToasts);t();ee();var Yp={errorMessage:Pa,successMessage:Ca,processingMessage:Na},Ga=e=>e.transactionsInfo,Jp=L(Ga,(e,o)=>o,(e,o)=>o!=null&&(e==null?void 0:e[Number(o)])||Yp);t();t();var mo=require("@multiversx/sdk-core");j();t();var Va=require("@multiversx/sdk-core/out");t();t();function mr(e){try{let o=atob(e),n=btoa(o),r=i.Buffer.from(e,"base64").toString(),a=i.Buffer.from(r).toString("base64"),p=e===n||n.startsWith(e),m=e===a||a.startsWith(e);if(p&&m)return!0}catch(o){return!1}return!1}function zo(e){return mr(e)?atob(e):e}t();t();function Ha(e){for(let o=0;o<e.length;o++)if(e.charCodeAt(o)>127)return!1;return!0}function jn(e){let o=e;try{let n=i.Buffer.from(e,"hex").toString();Ha(n)&&n.length>1&&(o=n)}catch(n){}return o}t();t();var Zp=e=>{let o=e!=null?e:"";return mr(o)?Va.TransactionPayload.fromEncoded(o):new Va.TransactionPayload(o)};t();j();var wn=({data:e,onlySetGuardian:o})=>e?o?e.startsWith("SetGuardian"):Object.values(ma).some(n=>e.startsWith(n)):!1;function qn(e){var r,a,p;let o=h({},e);wn({data:o.data,onlySetGuardian:!0})&&(delete o.senderUsername,delete o.receiverUsername);let n=new mo.Transaction(h(h(D(h(D(h({value:o.value.valueOf(),data:Zp(o.data),nonce:o.nonce.valueOf(),receiver:new mo.Address(o.receiver)},o.receiverUsername?{receiverUsername:o.receiverUsername}:{}),{sender:new mo.Address(o.sender)}),o.senderUsername?{senderUsername:o.senderUsername}:{}),{gasLimit:(r=o.gasLimit.valueOf())!=null?r:kt,gasPrice:(a=o.gasPrice.valueOf())!=null?a:Lt,chainID:o.chainID.valueOf(),version:new mo.TransactionVersion((p=o.version)!=null?p:Js)}),o.options?{options:new mo.TransactionOptions(o.options)}:{}),o.guardian?{guardian:new mo.Address(o.guardian)}:{}));return o.guardianSignature&&n.applyGuardianSignature(i.Buffer.from(o.guardianSignature,"hex")),o.signature&&n.applySignature(i.Buffer.from(o.signature,"hex")),n}t();t();j();function Tf(e,o){let n=new URLSearchParams(e),r=Object.fromEntries(n);return{nextUrlParams:new URLSearchParams(h(h({},r),o)).toString(),params:r}}var xf="3.1.6";function dr({callbackUrl:e,urlParams:o={}}){let n=e;if(Object.entries(o).length>0)try{let{search:r,origin:a,pathname:p,hash:m}=new URL(e),d=D(h({},o),{[Et]:xf}),{nextUrlParams:l}=Tf(r,d);n=`${a}${p}?${l}${m}`}catch(r){return console.error("Unable to construct URL from: ",e,r),n}return n}t();t();t();var Sf=require("@multiversx/sdk-core/out");t();j();t();var em=require("@multiversx/sdk-core");le();t();var Qp=require("@multiversx/sdk-core");function bf(e){try{let o=new Qp.Address(e);return Boolean(o.bech32())}catch(o){return!1}}function vn(e){return(e==null?void 0:e.length)===62&&/^\w+$/.test(e)&&bf(e)}t();t();t();var ja=require("@multiversx/sdk-core"),lr=C(require("bignumber.js"));ce();var $a={tokenId:"",amount:""},om=e=>e.split("@").map((p,m)=>[2,3].includes(m)?p:jn(p));function qa(e){if(!e)return $a;let o=e.startsWith("ESDTTransfer"),n=e.startsWith("ESDTNFTTransfer")&&e.includes("@"),r=e.startsWith("ESDTNFTBurn")&&e.includes("@");if(o){let[,a,p]=e.split("@");try{let m=i.Buffer.from(a,"hex").toString("ascii");if(!m)return $a;let d=new lr.default("0x"+p.replace("0x","")).toString(10);return{tokenId:m,amount:d}}catch(m){console.error("Error getting token from transaction data",m)}}if(n)try{let[,a,p,m,d]=om(e);if([a,p,m,d].every(l=>Boolean(l))&&vn(new ja.Address(d).bech32()))return{tokenId:`${a}-${p}`,amount:new lr.default(m,16).toString(10),collection:a,nonce:p,receiver:new ja.Address(d).bech32()}}catch(a){}if(r)try{let[,a,p,m]=om(e);if([a,p,m].every(d=>Boolean(d)))return{tokenId:`${a}-${p}`,amount:new lr.default(m,16).toString(10),collection:a,nonce:p}}catch(a){}return $a}t();t();t();var Ko="accounts";var za="blocks";var zn="economics";var Ka="nfts";var Xa="tokens";var In="transactions";t();t();t();t();Re();t();t();Re();t();t();t();var Lf=C(require("bignumber.js"));j();t();var kf=require("@multiversx/sdk-core"),Ya=C(require("bignumber.js"));j();t();var If=C(require("bignumber.js"));t();Ya.default.config({ROUNDING_MODE:Ya.default.ROUND_FLOOR});t();t();t();j();t();t();t();t();j();t();j();t();var Ef=require("@multiversx/sdk-core");j();t();var Xn=require("@multiversx/sdk-core"),Nf=C(require("bignumber.js"));j();t();t();var Pf=C(require("bignumber.js"));j();t();j();t();var Za={isEsdt:!1,isNft:!1,isEgld:!1};function Qa(e){let o=e==null?void 0:e.split("-").length;return o===2?D(h({},Za),{isEsdt:!0}):o===3?D(h({},Za),{isNft:!0}):D(h({},Za),{isEgld:!0})}t();t();t();t();t();j();t();j();t();j();t();Re();var Df=["reDelegateRewards","claimRewards","unBond"],Mf=["wrapEgld","unwrapEgld"],Of=["unStake"],Ff=["unDelegate"];t();t();t();j();t();var Wf=C(require("bignumber.js"));t();t();Re();t();var Hf=C(require("bignumber.js"));t();t();t();function am({tokenId:e,erdLabel:o}){return Boolean(e&&e!==o)}t();var oi=C(require("bignumber.js"));le();t();var im=(e,o)=>{let n=[],r=e.indexOf(o,0);for(;r>=0;)n.push(r),r=e.indexOf(o,r+1);return n};function sm(e){let o=[],n=0;try{if((e==null?void 0:e.startsWith("MultiESDTNFTTransfer"))&&(e==null?void 0:e.includes("@"))){let[,r,a,...p]=e==null?void 0:e.split("@");if(r){let m=new oi.default(a,16).toNumber();if(m>=Number.MAX_SAFE_INTEGER)return[];let d=0;for(let g=0;g<m;g++){let T={type:"nftTransaction",data:"",receiver:r};for(let v=0;v<3;v++){switch(v){case 0:T.token=jn(p[d]),T.data=p[d];break;case 1:{let y=p[d]&&p[d].length?p[d]:"";y&&y!=="00"?T.nonce=y:T.type="esdtTransaction",T.data=`${T.data}@${p[d]}`;break}case 2:T.amount=new oi.default(p[d],16).toString(10),T.data=`${T.data}@${p[d]}`;break;default:break}n=d+1,d++}o[g]=T}let l=o.length!==m,_=o.some(g=>im(g.data,"@").length!==2),u=o.some(g=>g.data.startsWith("@"));if(l||_||u)return[];if(p[n]){let g=p[n];for(let T=n+1;T<p.length;T++)g+="@"+p[T];o[m]={type:"scCall",data:g,receiver:r}}}}}catch(r){return console.error("failed parsing tx",r),o}return o}t();t();t();ce();function Oo(e){let n=Object.getPrototypeOf(e).toPlainObject!=null?e:qn(e),r=D(h({},n.toPlainObject()),{hash:n.getHash().hex(),senderUsername:n.getSenderUsername().valueOf(),receiverUsername:n.getReceiverUsername().valueOf(),status:"pending"});return wn({data:r.data,onlySetGuardian:!0})&&(delete r.senderUsername,delete r.receiverUsername),r}t();var mm=require("@multiversx/sdk-web-wallet-provider");j();t();var pm=C(require("qs"));t();ve();var ur=e=>{let o=new URLSearchParams(e).toString(),{pathname:n,hash:r}=q(),a=o?`?${o}`:"",p=n?`${n}${a}${r}`:"./";setTimeout(()=>{window==null||window.history.replaceState({},document==null?void 0:document.title,p)})};fn();t();fn();var $f={search:To()?window.location.search:"",removeParams:[]},cm=(e,o=$f)=>{var m;let n={},r=To()?window.location.search:"",a=(m=o.search)!=null?m:r;if(a){let d=a?new URLSearchParams(a):[];n=Object.fromEntries(d)}let p={};return e.forEach(d=>{p[d]=n[d],delete n[d]}),o.removeParams!=null&&Object.keys(n).forEach(d=>{var _,u;let[l]=d.split("[");(((_=o.removeParams)==null?void 0:_.includes(d))||((u=o.removeParams)==null?void 0:u.includes(l)))&&delete n[d]}),{remainingParams:p,params:n,clearNavigationHistory:()=>ur(n)}};var gr=({removeParams:e,search:o})=>{let n=To()?window.location.search:"",r=o!=null?o:n;if(!r)return{};let a=pm.default.parse(r.replace("?","")),p=Object.keys(a).filter(d=>!e.includes(d)),{remainingParams:m}=cm(p,{search:o,removeParams:e});return ur(m),m};var dm=({transaction:e,search:o})=>gr({removeParams:[...Object.keys(e),mm.WALLET_PROVIDER_CALLBACK_PARAM,ao,Et],search:o});t();t();t();Se();t();Re();t();t();Se();t();var jf=C(require("linkifyjs"));t();j();t();var qf=C(require("bignumber.js"));t();le();t();t();ce();t();ce();t();t();t();Re();t();Re();t();var zf=C(require("bignumber.js"));j();Re();t();Re();t();var _m=require("react");le();t();t();Re();t();t();var Kf=require("@multiversx/sdk-core/out"),Xf=C(require("bignumber.js"));Re();t();le();t();t();le();var hP=[{label:"Raw",value:"raw"},{label:"Text",value:"text"},{label:"Decimal",value:"decimal"},{label:"Smart",value:"smart"}];t();var um=require("react");le();Se();t();var Jf=require("react");Re();var IP=["create","localMint","ESDTLocalMint","addQuantity","burn","localBurn","ESDTLocalBurn","wipe","writeLog","signalError"];yn();t();var fr=e=>e.transactions,Xo=L(fr,e=>e.signedTransactions),gm=L(fr,e=>e.signTransactionsError),hr=L(fr,e=>e.signTransactionsCancelMessage),Tr=e=>o=>Object.entries(o).reduce((n,[r,a])=>(e(a.status)&&(n[r]=a),n),{}),xr=L(Xo,Tr(so)),yr=L(Xo,Tr(No)),Sr=L(Xo,Tr(Ro)),fm=L(Xo,Tr(Xt)),br=L(fr,e=>{var o;return(e==null?void 0:e.transactionsToSign)==null?null:D(h({},e.transactionsToSign),{transactions:((o=e==null?void 0:e.transactionsToSign)==null?void 0:o.transactions.map(n=>qn(n)))||[]})}),hm=L(Xo,(e,o)=>o,(e,o)=>o!=null?(e==null?void 0:e[o])||{}:{});var Jn=()=>w(qe);t();var wr=require("react");function ni(e,o=[]){let n=(0,wr.useRef)(!0);(0,wr.useEffect)(()=>{n.current?n.current=!1:e()},o)}t();ee();function Zf(){let e=w(Wp),o=K();return{notification:e,clearNotification:()=>o(Ic())}}t();t();t();t();function Zn(){let e=w(xr),o=Object.entries(e),n=(o==null?void 0:o.length)>0;return{pendingTransactions:e,pendingTransactionsArray:o,hasPendingTransactions:n}}t();t();t();t();var xm=require("@multiversx/sdk-extension-provider"),ym=require("@multiversx/sdk-hw-provider"),Sm=require("@multiversx/sdk-metamask-provider/out/metamaskProvider"),bm=require("@multiversx/sdk-opera-provider"),wm=require("@multiversx/sdk-passkey-provider/out"),ti=require("@multiversx/sdk-web-wallet-provider");j();Po();t();var ze=require("@multiversx/sdk-web-wallet-iframe-provider/out"),Tm=require("@multiversx/sdk-web-wallet-iframe-provider/out/constants");ce();t();var vr={},Ir=An;var Qf="/dapp/init",We=e=>{switch(e==null?void 0:e.constructor){case ti.WalletProvider:return"wallet";case Ir:return"walletconnectv2";case ym.HWProvider:return"ledger";case xm.ExtensionProvider:return"extension";case wm.PasskeyProvider:return"passkey";case Sm.MetamaskProvider:return"metamask";case bm.OperaProvider:return"opera";case Te.CrossWindowProvider:return"crossWindow";case ze.IframeProvider:return"iframe";case An:return"";default:return"extra"}},Ar=e=>new ti.WalletProvider(`${e}${Qf}`),kr=e=>f(void 0,null,function*(){if(!e.isInitialized())throw new Error("Unable to get version. Provider not initialized");let o=e.hwApp,{contractData:n,version:r}=yield o.getAppConfiguration();return{version:r,dataEnabled:n===Zs}}),Ye=e=>`Unable to perform ${e}, Provider not initialized`,An=class{init(){return Promise.resolve(!1)}getAccount(){throw new Error(Ye("getAccount"))}setAccount(o){throw new Error(Ye(`setAccount: ${o}`))}login(o){throw new Error(Ye(`login with options: ${o}`))}logout(o){throw new Error(Ye(`logout with options: ${o}`))}getAddress(){throw new Error(Ye("getAddress"))}isInitialized(){return!1}isConnected(){return!1}sendTransaction(o,n){throw new Error(Ye(`sendTransaction with transactions: ${o} options: ${n}`))}signTransaction(o,n){throw new Error(Ye(`signTransaction with transactions: ${o} options: ${n}`))}signTransactions(o,n){throw new Error(Ye(`signTransactions with transactions: ${o} options: ${n}`))}signMessage(o,n){throw new Error(Ye(`signTransactions with ${o} and options ${n}`))}sendCustomMessage({method:o,params:n}){throw new Error(Ye(`sendCustomMessage with method: ${o} params: ${n}`))}sendCustomRequest(o){throw new Error(Ye(`sendSessionEvent with options: ${o}`))}ping(){return Promise.resolve(!1)}},Qn=new An;var ri=Qn,vm=null;function Ie(e){ri=e}function Im(){vm!=null&&(ri=vm)}function Ae(){return ri||Qn}ee();t();t();t();t();t();var Am=require("@lifeomic/axios-fetch"),ai=C(require("axios")),ii=(0,Am.buildAxiosFetch)(ai.default),si=(e,o)=>f(void 0,null,function*(){if(!e.ok)throw new Error(`HTTP error! Status: ${e.status}`);let r=e.clone().json(),[a]=yield Promise.all([r]);return{data:a,status:e.status,statusText:e.statusText,headers:e.headers,config:o}});function eh(e,o,n){return f(this,null,function*(){try{let r=yield ii(e,h({method:"POST",body:o?JSON.stringify(o):void 0,headers:h({"Content-Type":"application/json"},(n==null?void 0:n.headers)||{})},n));return si(r,n)}catch(r){throw console.error("Fetch Error:",r),r}})}function oh(e,o){return f(this,null,function*(){try{let n=yield ii(e,o);if(!n.ok)throw new Error(`HTTP error! Status: ${n.status}`);return si(n,o)}catch(n){throw console.error("Fetch Error:",n),n}})}function nh(e,o,n){return f(this,null,function*(){try{let r=yield ii(e,h({method:"PATCH",body:o?JSON.stringify(o):void 0,headers:(n==null?void 0:n.headers)||{}},n));if(!r.ok)throw new Error(`HTTP error! Status: ${r.status}`);return si(r,n)}catch(r){throw console.error("Fetch Error:",r),r}})}var Io=ai.default.create();Io.get=oh;Io.post=eh;Io.patch=nh;var km=e=>Io.get(e).then(o=>o.data);t();var Yo=e=>{let o=e!=null?e:ir(P.getState());return o.endsWith("/")?o.slice(0,-1):o};t();var Lm=C(require("axios"));function Em(e){return f(this,null,function*(){let{network:{apiAddress:o,apiTimeout:n}}=qe(P.getState()),{data:r}=yield Lm.default.get(`${o}/${Ko}/${e}`,{timeout:Number(n)});return r})}t();var Pm=C(require("swr"));var kn=({apiEndpoint:e})=>{let o=Yo(),n=e?`${o}/${e}`:null;return(0,Pm.default)(n,km)};var th=e=>{let n=`${Yo()}/${Ko}/${e}?withGuardianInfo=true`;return Io.get(n)},Cm=e=>f(void 0,null,function*(){if(!e)return null;try{let{data:o}=yield th(e);return o}catch(o){console.error("error fetching configuration for ",e,o)}return null});var Fo=e=>Cm(e);t();ce();t();t();function Nm(){let e=Ae();return We(e)}function Ao(e){return Nm()===e}t();Se();var Rm=()=>{let{search:e}=q(),o=new URLSearchParams(e),n=Object.fromEntries(o),r=n==null?void 0:n.address;return vn(r)?r:null};function et(){let e=P.getState(),o=Ae(),n=wo(e),r=Mo(e),a=Fp(e);if(!o)throw"provider not initialized";return Ao("ledger")&&r?new Promise(p=>{p(n)}):!Ao("")&&!Ao("wallet")&&!Ao("extra")?o.getAddress():new Promise(p=>{let m=Rm();a!=null&&m&&p(m),r&&p(n),p("")})}t();function Jo(e){let o=P.getState(),n=Cp(o);return e?n&&!isNaN(n)?Math.max(n,e.nonce):e.nonce:n}var Dm=()=>f(void 0,null,function*(){try{let e=yield et();try{let o=yield Fo(e);if(o!=null){let n=D(h({},o),{nonce:Jo(o)});return P.dispatch(un(n)),n}}catch(o){console.error("Failed getting account ",o)}}catch(e){console.error("Failed getting address ",e)}return null});function Lr(){return f(this,null,function*(){let e=Ae();if(e==null)throw"Provider not initialized";if(!e.isInitialized||e.isInitialized())return Dm();try{if(!e.init)throw"Current provider does not have init() function";return(yield e.init())?Dm():void 0}catch(o){console.error("Failed initializing provider ",o)}})}yn();t();t();t();var rh=C(require("axios"));t();var ih=C(require("axios"));cn();t();j();t();var Mm=C(require("axios"));var Om=e=>f(void 0,null,function*(){let o=ir(P.getState()),n=e.map(a=>a.hash),{data:r}=yield Mm.default.get(`${o}/${In}`,{params:{hashes:n.join(","),withScResults:!0}});return e.map(({hash:a,previousStatus:p})=>{let m=r.find(d=>(d==null?void 0:d.txHash)===a);return{hash:a,data:m==null?void 0:m.data,invalidTransaction:m==null,status:m==null?void 0:m.status,results:m==null?void 0:m.results,sender:m==null?void 0:m.sender,receiver:m==null?void 0:m.receiver,previousStatus:p,hasStatusChanged:m&&m.status!==p}})});t();var ch=C(require("axios"));t();t();var ph=C(require("axios"));t();var mh=C(require("axios"));t();t();ee();ce();t();t();t();t();Se();var Um=()=>{let{search:e}=q(),o=new URLSearchParams(e),n=Object.fromEntries(o);return n==null?void 0:n.accessToken};var Bm=()=>{var n;let e=Um(),o=Pe(P.getState());return e!=null?e:(n=o.webviewLogin)==null?void 0:n.data};t();me();le();t();ee();t();var Wm=require("@multiversx/sdk-core");le();ve();t();yn();function Gm(e,o){return e.reduce((r,{status:a,hash:p})=>(p!=null&&!o.includes(p)&&so(a)&&r.push({hash:p,previousStatus:a}),r),[])}t();ee();ce();function Hm({results:e,hash:o,sessionId:n}){let r=e==null?void 0:e.find(a=>(a==null?void 0:a.returnMessage)!=="");P.dispatch(Sn({transactionHash:o,sessionId:n,status:"fail",errorMessage:r==null?void 0:r.returnMessage,inTransit:!1,serverTransaction:r})),P.dispatch(Yt({sessionId:n,status:"fail",errorMessage:r==null?void 0:r.returnMessage}))}t();ee();le();function ci(e){P.dispatch(Yt({sessionId:e,status:"timedOut"}))}var Er={},pi=[];function dh({serverTransaction:e,sessionId:o,customTransactionInformation:n,shouldRefreshBalance:r,isSequential:a}){let{hash:p,status:m,inTransit:d,results:l,invalidTransaction:_,hasStatusChanged:u}=e;try{if(pi.includes(p))return;if(Er[p]>30){ci(o);return}if(_&&!a||so(m)){Er[p]=Er[p]?Er[p]+1:1;return}if(a&&!m){P.dispatch(Sn({sessionId:o,status:m,transactionHash:p,inTransit:d,serverTransaction:e}));return}u&&(No(m)&&(n==null?void 0:n.completedTransactionsDelay)!=null?(pi.push(p),setTimeout(()=>P.dispatch(Sn({sessionId:o,status:"success",transactionHash:p,inTransit:d,serverTransaction:e})),n==null?void 0:n.completedTransactionsDelay)):P.dispatch(Sn({sessionId:o,status:m,transactionHash:p,inTransit:d,serverTransaction:e}))),r||Lr(),Ro(m)&&Hm({sessionId:o,hash:p,results:l})}catch(g){console.error(g),ci(o)}}function Vm(l){return f(this,arguments,function*({sessionId:e,transactionBatch:{transactions:o,customTransactionInformation:n},getTransactionsByHash:r=Om,shouldRefreshBalance:a,isSequential:p,onSuccess:m,onFail:d}){try{if(o==null)return;let _=Gm(o,pi),u=yield r(_);for(let T of u)dh({serverTransaction:T,sessionId:e,customTransactionInformation:n,shouldRefreshBalance:a,isSequential:p});if(u.every(T=>T.status!=="pending")&&!(n!=null&&n.grouping)){if(u.every(y=>y.status==="success"))return m==null?void 0:m(e);if(u.some(y=>y.status==="fail"))return d==null?void 0:d(e)}}catch(_){console.error(_)}})}function lh(){let{pendingTransactionsArray:e}=Zn();function o(n){return f(this,null,function*(){let r=e.filter(([,a])=>{var p;return!((p=a==null?void 0:a.customTransactionInformation)!=null&&p.grouping)}).filter(([a,p])=>a!=null&&so(p.status));if(r.length>0)for(let[a,p]of r)yield Vm(h({sessionId:a,transactionBatch:p},n));n.shouldRefreshBalance&&(yield Lr())})}return o}t();function _h(){var l,_,u;let e=w(fm),o=w(Sr),n=w(yr),r=w(xr),a=((l=Object.keys(r))==null?void 0:l.length)>0,p=!a&&((_=Object.keys(e))==null?void 0:_.length)>0,m=!a&&!p&&((u=Object.keys(o))==null?void 0:u.length)>0,d=!a&&!p&&!m&&Object.keys(n).length>0;return{pending:a,timedOut:p,fail:m,success:d}}t();function uh(){let e=w(Sr),o=Object.entries(e),n=(o==null?void 0:o.length)>0;return{failedTransactions:e,failedTransactionsArray:o,hasFailedTransactions:n}}t();le();var gh=()=>{var r,a;let{hasPendingTransactions:e,pendingTransactions:o}=Zn();if(!e)return"";let n=Object.keys(o).sort().reverse();for(let p of n){let d=(a=(r=o[p].transactions)==null?void 0:r.filter(l=>l.status==="pending"))!=null?a:[];if(d.length>0)return d[d.length-1].hash}return""};t();At();var hh=()=>{let e=w(Gp);return e?Math.max(1e3,e/2):9e4};t();var Th=()=>w(gm);t();function ot(){let e=w(Xo),o=Object.entries(e),n=(o==null?void 0:o.length)>0;return{signedTransactions:e,signedTransactionsArray:o,hasSignedTransactions:n}}t();function xh(){let e=w(yr),o=Object.entries(e),n=(o==null?void 0:o.length)>0;return{successfulTransactions:e,successfulTransactionsArray:o,hasSuccessfulTransactions:n}}t();var jm=C(require("swr"));t();t();var Pr={},mi={setItem:(e,o)=>f(void 0,null,function*(){try{Pr[e]=JSON.stringify(o)}catch(n){console.error("tokenDataStorage unable to serialize",n)}}),getItem:e=>f(void 0,null,function*(){try{return JSON.parse(Pr[e])}catch(o){console.error("tokenDataStorage unable to parse",o)}}),clear:()=>f(void 0,null,function*(){Pr={}}),removeItem:e=>f(void 0,null,function*(){delete Pr[e]})};function $m(e){return f(this,null,function*(){let{apiAddress:o,apiTimeout:n}=xe(P.getState()),r={baseURL:o,timeout:Number(n)},a=yield mi.getItem(e);if(a)return a;let p=yield Io.get(e,r);return yield mi.setItem(e,p.data),p.data})}function yh({tokenId:e}){var g,T,v,y;let{network:o}=Jn(),{isNft:n}=Qa(e),r=e,a=n?Ka:Xa,{data:p,error:m,isLoading:d}=(0,jm.default)(Boolean(r)?`${o.apiAddress}/${a}/${r}`:null,$m);if(!r)return{tokenDecimals:Number(o.decimals),tokenLabel:"",tokenAvatar:""};let l=p?p==null?void 0:p.decimals:Number(o.decimals),_=p?p==null?void 0:p.name:"",u=p?(y=(g=p==null?void 0:p.assets)==null?void 0:g.svgUrl)!=null?y:(v=(T=p==null?void 0:p.media)==null?void 0:T[0])==null?void 0:v.thumbnailUrl:"";return{isLoading:d,tokenDecimals:l,tokenLabel:_,type:p==null?void 0:p.type,tokenAvatar:u,identifier:p==null?void 0:p.identifier,assets:p==null?void 0:p.assets,esdtPrice:p==null?void 0:p.price,ticker:p==null?void 0:p.ticker,name:p==null?void 0:p.name,error:m}}t();function Sh(e){return w(o=>Jp(o,e))}t();var nt=require("react");t();function qm({parsedTransactionsByDataField:e,data:o,txInfo:n}){!e||(e[o]=n)}function zm({transactions:e}){let o={},n=[];return!e||e.length===0?{allTransactions:n,parsedTransactionsByDataField:o}:(e.forEach((r,a)=>{let p=r.getData().toString(),m=sm(p);if(m.length>0)m.forEach((d,l)=>{let _={transaction:r,multiTxData:d.data,transactionIndex:l};qm({parsedTransactionsByDataField:o,data:d.data,txInfo:{tokenId:d.token?d.token:"",amount:d.amount?d.amount:"",type:d.type,nonce:d.nonce?d.nonce:"",multiTxData:d.data,receiver:d.receiver}}),n.push(_)});else{let d=r.getData().toString(),{tokenId:l,amount:_}=qa(d);l&&qm({parsedTransactionsByDataField:o,data:d,txInfo:{tokenId:l,amount:_,receiver:r.getReceiver().bech32()}}),n.push({transaction:r,transactionIndex:a,multiTxData:d})}}),{allTransactions:n,parsedTransactionsByDataField:o})}var Km={tokenId:"",amount:"",type:"",multiTxData:"",receiver:""};function di({transactions:e}){let[o,n]=(0,nt.useState)({}),[r,a]=(0,nt.useState)([]);function p(d,l){return o==null?Km:d in o?o[d]:l!=null&&String(l)in o?o[l]:Km}function m(){let{allTransactions:d,parsedTransactionsByDataField:l}=zm({transactions:e});a(d),n(l)}return(0,nt.useEffect)(()=>{m()},[e==null?void 0:e.length]),{parsedTransactionsByDataField:o,getTxInfoByDataField:p,allTransactions:r}}t();var Xm=require("react"),Ym=require("@multiversx/sdk-web-wallet-provider"),Jm=require("@multiversx/sdk-web-wallet-provider"),Zm=C(require("qs"));j();ee();ce();ua();Se();var bh=q();function tt(e){let o=w(xe),n=K(),{shouldFetchWalletUrlOnLoad:r}=w(Ba),{search:a}=r?bh:q();(0,Xm.useEffect)(()=>{if(a!=null){let p=Zm.default.parse(a.replace("?",""));if(p&&ao in p){let m=String(p[ao]),d=new Ym.WalletProvider(`${o.walletAddress}${Qs}`).getTransactionsFromWalletUrl(a);if(p.status==="cancelled"){n(co({sessionId:m,status:"cancelled"})),e(),gr({removeParams:[...Object.keys(_a),Jm.WALLET_PROVIDER_CALLBACK_PARAM,ao,"address"],search:a}),n(So(ho));return}if(d.length>0){n(co({sessionId:m,status:"signed",transactions:d.map(_=>Oo(_))}));let[l]=d;dm({transaction:l,search:a})}}}},[a])}t();var en=require("react"),on=require("@multiversx/sdk-core");t();var Ln=e=>kn({apiEndpoint:e?`${Ko}/${e}?withGuardianInfo=true`:null});j();Aa();t();t();var Cr=(e,o)=>e?Array.isArray(o)?o.some(n=>e.address===n||e.activeGuardianAddress===n):e.address===o||e.activeGuardianAddress===o:!0;t();function Nr(e){let o=br(P.getState()),n=Object.keys(e).length===(o==null?void 0:o.transactions.length);return e&&(e&&n)}t();t();t();var li=({accountNonce:e,transactionNonce:o})=>o&&o>e?o:e;var Qm=({latestNonce:e,transactions:o})=>o.length===0?o:o.map((n,r)=>{let a=e+r,p=n.getNonce().valueOf(),m=li({accountNonce:a,transactionNonce:p});return n.setNonce(m),n});var Rr=()=>{let e=w(wo),{data:o}=Ln(e);return n=>f(void 0,null,function*(){let r=o!=null?o:yield Fo(e),a=Jo(r);return Qm({latestNonce:a,transactions:n})})};t();var rt=({transactions:e,isGuarded:o})=>o?e.length===0?!1:e.every(n=>Boolean(n.getGuardianSignature().toString("hex"))):!0;t();t();t();cn();t();var Ih=C(require("axios"));t();var kh=C(require("axios"));t();cn();t();cn();function _i(e){return js[e]}t();t();t();t();var Lh=require("@multiversx/sdk-opera-provider");t();var Eh=require("@multiversx/sdk-extension-provider");t();Po();function ed(n){return f(this,arguments,function*({address:e,walletUrl:o}){try{let r=yield Te.CrossWindowProvider.getInstance().init(),a=Te.CrossWindowProvider.getInstance().setAddress(e).setWalletUrl(o);if(r)return a;console.error("Could not initialise Cross Window Wallet provider")}catch(r){console.error("Unable to login to CrossWindowWalletProvider",r)}return null})}t();t();t();t();var yd=C(xd());var Zo=e=>{if(!e||!(0,yd.default)(e))return null;let o=e.split(".");if(o.length!==4)return null;try{let[n,r,a,p]=o,m=JSON.parse(zo(p)),d=zo(n);return{ttl:Number(a),extraInfo:m,origin:d,blockHash:r}}catch(n){return console.error(`Error trying to decode ${e}:`,n),null}};t();var Ad=require("@multiversx/sdk-native-auth-client");t();var wd=C(require("axios"));t();t();t();function Sd(e){return f(this,null,function*(){return yield new Promise(o=>{setTimeout(()=>o(),e)})})}t();var bd=(e,o,n,r=0)=>f(void 0,null,function*(){try{return yield e(...n)}catch(a){return r<o.retries?((o==null?void 0:o.delay)!=null&&(yield Sd(o.delay)),yield bd(e,o,n,r+1)):null}}),Dr=(e,o={retries:5,delay:500})=>(...n)=>f(void 0,null,function*(){return yield bd(e,o,n)});var eT=4,oT=3e4,Mr={current:null},Qo={current:null},nT=Dr((e,o,n)=>f(void 0,null,function*(){if(n){let p=Math.floor(Date.now()/1e3);return{hash:yield n(),timestamp:p}}let{data:r}=yield wd.default.get(`${e}/${za}?from=${eT}&size=1&fields=hash,timestamp${o?"&shard="+o:""}`),[a]=r;return a}));function vd(e,o,n,r){return f(this,null,function*(){if(e==null)throw new Error("missing api url");let a=Date.now();if(Mr.current!=null&&a<Mr.current.timestamp*1e3+oT&&!r)return Mr.current;if(Qo.current!=null)return yield Qo.current;Qo.current=nT(e,o,n);try{let p=yield Qo.current;if(p==null)throw Qo.current=null,new Error("could not get block hash");return Mr.current={hash:p.hash,timestamp:p.timestamp},Qo.current=null,p}catch(p){return Qo.current=null,null}})}t();t();Ct();t();function tT(e){return Object.prototype.toString.call(e)==="[object String]"}var Or=e=>{var n;if(!e||!tT(e))return null;let o=e.split(".");if(o.length!==3)return console.error("Invalid nativeAuthToken. You may be trying to decode a loginToken. Try using decodeLoginToken method instead"),null;try{let[r,a,p]=o,m=zo(r),d=zo(a),l=Zo(d);if(!l)return{address:m,body:d,signature:p,blockHash:"",origin:"",ttl:0};let _=D(h({},l),{address:m,body:d,signature:p});return(n=l.extraInfo)!=null&&n.timestamp||delete _.extraInfo,_}catch(r){return null}};var fi={isExpired:!1},Id=e=>{if(!e)return fi;let o=Or(e);if(!o)return fi;let n=dn(),{ttl:r,extraInfo:a}=o,p=a==null?void 0:a.timestamp;if(!p)return fi;let m=p+r,d=n>m,l=m-n;return{isExpired:d,expiresAt:m,secondsUntilExpires:l}};t();Se();var st={origin:q().origin,apiAddress:"https://api.multiversx.com",expirySeconds:60*60*24,tokenExpirationToastWarningSeconds:5*60},ct=e=>{var n,r,a,p,m,d;return e===!0?st:{origin:(n=e==null?void 0:e.origin)!=null?n:st.origin,blockHashShard:e==null?void 0:e.blockHashShard,expirySeconds:(r=e==null?void 0:e.expirySeconds)!=null?r:st.expirySeconds,apiAddress:(a=e==null?void 0:e.apiAddress)!=null?a:st.apiAddress,tokenExpirationToastWarningSeconds:(p=e==null?void 0:e.tokenExpirationToastWarningSeconds)!=null?p:st.tokenExpirationToastWarningSeconds,extraInfo:(m=e==null?void 0:e.extraInfo)!=null?m:{},gatewayUrl:e==null?void 0:e.gatewayUrl,extraRequestHeaders:(d=e==null?void 0:e.extraRequestHeaders)!=null?d:{}}};var pt=e=>{let{origin:o,apiAddress:n,expirySeconds:r,blockHashShard:a,extraInfo:p,gatewayUrl:m,extraRequestHeaders:d}=ct(e),l=new Ad.NativeAuthClient({origin:o,apiUrl:n,expirySeconds:r,blockHashShard:a,gatewayUrl:m,extraRequestHeaders:d});return{getNativeAuthConfig:ct,initialize:g=>f(void 0,null,function*(){var v,y;if(!n||!o)return"";let T=()=>l.getCurrentBlockHash();try{let b=(v=g==null?void 0:g.latestBlockInfo)!=null?v:yield vd(n,a,T,g==null?void 0:g.noCache);if(!b)return"";let{hash:S,timestamp:A}=b,N=l.encodeValue(JSON.stringify(h(h({},(y=g==null?void 0:g.extraInfo)!=null?y:p),A?{timestamp:A}:{})));return`${l.encodeValue(o)}.${S}.${r}.${N}`}catch(b){return console.error("Error getting native auth token: ",b.toString()),""}}),getToken:({address:g,token:T,signature:v})=>l.getToken(g,T,v),getTokenExpiration:Id}};var kd=n=>f(void 0,[n],function*({loginToken:e,extraInfoData:o}){if(e==null||Object.keys(o).length===0)return null;let r=Zo(String(e)),_=(r==null?void 0:r.extraInfo)||{},{timestamp:a}=_,p=Eo(_,["timestamp"]);if(!(r&&a!=null))return null;let d={hash:String(r==null?void 0:r.blockHash),timestamp:Number(a)};return yield pt({extraInfo:h(h({},p),o),expirySeconds:r==null?void 0:r.ttl,origin:r==null?void 0:r.origin}).initialize({latestBlockInfo:d})});var Ld=p=>f(void 0,[p],function*({loginToken:e,extraInfoData:o,address:n,signature:r,loginService:a}){let m=yield kd({loginToken:e,extraInfoData:o}),d=o.multisig||o.impersonate||n,l=m!=null?d:n;return m!=null&&a.setLoginToken(m),r&&a.setTokenLoginInfo({signature:r,address:n}),yield Fo(l)});t();var rT=require("@multiversx/sdk-metamask-provider/out/metamaskProvider");t();var aT=require("@multiversx/sdk-passkey-provider/out");j();Se();var Fr=({transactions:e,hasGuardianScreen:o,callbackRoute:n,sessionId:r,walletAddress:a,isGuarded:p})=>{let m=rt({isGuarded:p,transactions:e}),d=e[0].getChainID().valueOf(),l=e[0].getSender().bech32().toString(),_=_i(d),u=a!=null?a:$o[_].walletAddress;return{needs2FaSigning:p?!o&&!m&&r:!1,sendTransactionsToGuardian:()=>{let y=Ar(u),b={[ao]:String(r)},{origin:S}=q(),A=window!=null&&window.location?`${S}${n}`:`${n}`,N=dr({callbackUrl:A,urlParams:b});y.guardTransactions(e,{callbackUrl:encodeURIComponent(N)})},guardTransactions:()=>f(void 0,null,function*(){let y=yield ed({address:l,walletUrl:u});return y==null||y.setShouldShowConsentPopup(!0),yield y==null?void 0:y.guardTransactions(e)})}};t();t();t();var Nd=require("react"),hi=require("@multiversx/sdk-hw-provider");t();pn();me();le();t();function Ed(e,o){if(!e){typeof console!="undefined"&&console.warn(o);try{throw new Error(o)}catch(n){}}}function Pd(e,o){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[n,r]=iT(e.path,e.caseSensitive,e.end),a=o.match(n);if(!a)return null;let p=a[0],m=p.replace(/(.)\/+$/,"$1"),d=a.slice(1);return{params:r.reduce((_,u,g)=>{if(u==="*"){let T=d[g]||"";m=p.slice(0,p.length-T.length).replace(/(.)\/+$/,"$1")}return _[u]=sT(d[g]||"",u),_},{}),pathname:p,pathnameBase:m,pattern:e}}function iT(e,o=!1,n=!0){Ed(e==="*"||!e.endsWith("*")||e.endsWith("/*"),`Route path "${e}" will be treated as if it were "${e.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${e.replace(/\*$/,"/*")}".`);let r=[],a="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^$?{}|()[\]]/g,"\\$&").replace(/:(\w+)/g,(m,d)=>(r.push(d),"([^\\/]+)"));return e.endsWith("*")?(r.push("*"),a+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):a+=n?"\\/*$":"(?:(?=[.~-]|%[0-9A-F]{2})|\\b|\\/|$)",[new RegExp(a,o?void 0:"i"),r]}function sT(e,o){try{return decodeURIComponent(e)}catch(n){return Ed(!1,`The value for the URL param "${o}" will not be decoded because the string "${e}" is a malformed URL segment. This is probably due to a bad percent encoding (${n}).`),e}}Wn();_n();ln();ve();var Cd=({callbackUrl:e,onRedirect:o})=>{typeof o=="function"?o(e):e&&hn({url:e})},cT=e=>{let o=io.local.getItem(Ke.logoutEvent),{data:n}=o?JSON.parse(o):{data:e};e===n&&(io.local.setItem({key:Ke.logoutEvent,data:e,expires:0}),io.local.removeItem(Ke.logoutEvent))},pT=500;function mt(a,p){return f(this,arguments,function*(e,o,n=Boolean(Bm()),r={shouldBroadcastLogoutAcrossTabs:!0,hasConsentPopup:!1}){var b,S,A;let m=yield et(),d=Ae(),l=We(d),_=l==="wallet",u=((b=d==null?void 0:d.isInitialized)==null?void 0:b.call(d))===!0;if(n&&(d==null?void 0:d.relogin)!=null)return d.relogin();m&&r.shouldBroadcastLogoutAcrossTabs&&cT(m);let g=xo(e),T=q(),{pathname:v,origin:y}=new URL(decodeURIComponent(g));if((Pd(T.pathname,v)||_&&u||((S=De.safeWindow)==null?void 0:S.opener)&&y===((A=De.safeWindow)==null?void 0:A.origin))&&Cc(),!m&&!u)return Cd({callbackUrl:g,onRedirect:o});try{if(P.dispatch(ae()),_)return setTimeout(()=>{d.logout({callbackUrl:g})},pT);r.hasConsentPopup&&l==="crossWindow"&&d.setShouldShowConsentPopup(!0),yield d.logout({callbackUrl:g})}catch(N){console.error("Logging out error:",N)}finally{_||Cd({callbackUrl:g,onRedirect:o})}})}var Rd=()=>{let e=w(ar),o=w(Mo),n=w(Op),r=Ae(),[a,p]=(0,Nd.useState)(),m=()=>f(void 0,null,function*(){let l=(n==null?void 0:n.index)!=null;try{if(r instanceof hi.HWProvider&&r.isInitialized())return l&&(yield r.setAddressIndex(n.index)),r;let _=new hi.HWProvider;return(yield _.init())?(l&&(yield _.setAddressIndex(n.index)),_):null}catch(_){return console.error("Failed to initialise Ledger Provider"),null}});function d(l){return f(this,null,function*(){let _,u=o&&!(l!=null&&l.isRelogin);try{if(_=yield m(),!_){console.warn("Could not initialise ledger app"),u&&mt(e);return}let g=yield kr(_);return Ie(_),p(g),_}catch(g){console.error("Could not initialise ledger app",g),u&&mt(e)}return null})}return{setLedgerProvider:d,ledgerData:a}};t();var Je=()=>{let e=Ae(),o=We(e);return{provider:e,providerType:o}};var Dd=()=>{let{provider:e}=Je(),{setLedgerProvider:o}=Rd();return function(){return f(this,null,function*(){let r;try{let p=yield e.getAddress();r=Boolean(p)}catch(p){r=!1}if(r)return e;let a=yield o({isRelogin:!0});return a||e})}};var Ur={},Ti=({isLedger:e=!1,transactionsToSign:o,egldLabel:n,address:r,activeGuardianAddress:a,hasGuardianScreen:p,onCancel:m,onSignTransaction:d,onTransactionsSignError:l,onTransactionsSignSuccess:_,onGetScamAddressData:u})=>{var He,Ce,ne,fe;let g=Boolean(a),[T,v]=(0,en.useState)(0),[y,b]=(0,en.useState)(),[S,A]=(0,en.useState)(null),[N,M]=(0,en.useState)(!1),{getTxInfoByDataField:k,allTransactions:F}=di({transactions:a?o==null?void 0:o.map($=>{$.setSender(on.Address.fromBech32(r)),$.setVersion(on.TransactionVersion.withTxOptions()),$.setGuardian(on.Address.fromBech32(a));let Z=h({guarded:!0},e?{hashSign:!0}:{});return $.setOptions(on.TransactionOptions.withOptions(Z)),$}):o}),z=T===F.length-1,ie=F[T],U=(He=S==null?void 0:S.transaction)==null?void 0:He.getSender().toString(),{data:W}=Ln(!U||U===r?null:U),J=()=>f(void 0,null,function*(){var Le;if(ie==null)return;let{transaction:$,multiTxData:Z,transactionIndex:H}=ie,X=$.getData().toString(),O=k($.getData().toString(),Z),{tokenId:Y}=O,Q=$.getReceiver().toString();if(U&&U!==r&&!Cr(W,r))return console.error(Fn),m==null?void 0:m();let te=r!==Q,ge=Q in Ur;if(Q&&te&&!ge&&u!=null){let Ve=yield u(Q);Ur=h(h({},Ur),Ve!=null&&Ve.scamInfo?{[Q]:Ve.scamInfo}:{})}let ye=Boolean(Y&&am({tokenId:Y,erdLabel:n}));A({transaction:$,receiverScamInfo:((Le=Ur[Q])==null?void 0:Le.info)||null,transactionTokenInfo:O,isTokenTransaction:ye,dataField:X,transactionIndex:H})});(0,en.useEffect)(()=>{J()},[ie,W]);let R=()=>{v(0),b(void 0),M(!1)},V=()=>f(void 0,null,function*(){let $=Object.values(y!=null?y:{}),Z=rt({isGuarded:g,transactions:$});if(g&&Z){_($),R();return}if(S==null)return;M(e);let H;try{H=yield d(S.transaction)}catch(te){console.error(te,"sign error");let{message:ge}=te,ye=e?Wt(te).errorMessage:null;R(),l(ye!=null?ye:ge);return}if(!H)return;let X={[T]:H},O=y?h(h({},y),X):X;if(b(O),!z){v(te=>te+1),M(!1);return}if(!O)return;let Y=Object.values(O);!rt({isGuarded:g,transactions:Y})&&p||(_(Y),R())}),B=()=>f(void 0,null,function*(){try{if(S==null)return;if(S.transaction.getSignature().toString("hex")&&!z){v(Z=>Z+1);return}yield V()}catch($){console.error("Error during signing transaction"),yield V()}}),se=T===0,re=()=>{se?m==null||m():v($=>$-1)},ue=Boolean(((Ce=S==null?void 0:S.transactionTokenInfo)==null?void 0:Ce.type)&&((ne=S==null?void 0:S.transactionTokenInfo)==null?void 0:ne.multiTxData)&&!(S!=null&&S.dataField.endsWith((fe=S==null?void 0:S.transactionTokenInfo)==null?void 0:fe.multiTxData)));return{allTransactions:F,onSignTransaction:()=>f(void 0,null,function*(){if(ue){v($=>$+1);return}yield B()}),onNext:()=>{v($=>{let Z=$+1;return Z>(F==null?void 0:F.length)?$:Z})},onPrev:()=>{v($=>{let Z=$-1;return Z<0?$:Z})},waitingForDevice:N,onAbort:re,isLastTransaction:z,isFirstTransaction:T===0,hasMultipleTransactions:F.length>1,shouldContinueWithoutSigning:ue,currentStep:T,signedTransactions:y,setSignedTransactions:b,currentTransaction:S}};t();var gt=require("react"),$r=require("@multiversx/sdk-core"),Ci=require("@multiversx/sdk-extension-provider"),Ni=require("@multiversx/sdk-metamask-provider/out/metamaskProvider"),Ri=require("@multiversx/sdk-passkey-provider/out"),I_=C(x_());j();t();t();var lo=()=>w(qo);t();var bi=()=>w(Pp);t();var wi=()=>w(Dp);t();t();t();t();t();t();var Nn=C(require("react"));var Py=(0,Nn.createContext)({}),X5=P.getState();function Hr(){let e=(0,Nn.useContext)(Py);if(e===void 0||Object.values(e).length===0)throw new Error("useAxiosInterceptorContext must be used within an AxiosInterceptorContextProvider");return e}t();var y_=C(require("react"));t();var vi=C(require("react")),Cy=C(require("axios"));var Ii=()=>{try{let{loginInfo:e,isLoggedIn:o}=Hr();return D(h({},e),{isLoggedIn:o})}catch(e){let o=w(Pe),n=w(Mo);return D(h({},o),{isLoggedIn:n})}};var Ai=()=>{let{isLoggedIn:e}=Ii();return e};t();var Ny=()=>w(Up);t();var ki=()=>w(Rp);Po();t();t();var w_=require("@multiversx/sdk-dapp-utils/out/helpers/providerNotInitializedError"),v_=require("@multiversx/sdk-webview-provider/out/WebviewProvider");me();t();me();ee();le();function S_(e,o=P.dispatch){let n=Or(e);if(n==null)return;let{signature:r,address:a}=n;r&&e&&a&&(o(gn({loginToken:e,signature:r,nativeAuthToken:e})),o(pe({address:a,loginMethod:"extra"})))}t();t();ee();function b_(){P.dispatch(Qc())}function Vr(){P.dispatch(Do())}t();ve();t();ee();le();t();t();var Dy=require("@multiversx/sdk-core"),My=C(require("bignumber.js"));j();t();var Oy=C(require("bignumber.js"));j();var Ge=class{constructor(){this.init=()=>f(this,null,function*(){return yield this._provider.init()});this.login=()=>f(this,null,function*(){var n;let o=yield this._provider.login();return{address:(n=o==null?void 0:o.address)!=null?n:""}});this.logout=()=>f(this,null,function*(){return P.dispatch(ae()),yield this._provider.logout()});this.relogin=()=>f(this,null,function*(){let o=yield this._provider.relogin();return o?(S_(o),Im(),o):(console.error("Unable to re-login. Missing accessToken."),null)});this.signTransactions=o=>f(this,null,function*(){let n=yield this._provider.signTransactions(o);return n||(Vr(),this._provider.cancelAction(),null)});this.signTransaction=o=>f(this,null,function*(){return yield this._provider.signTransaction(o)});this.signMessage=o=>f(this,null,function*(){return yield this._provider.signMessage(o)});this.cancelAction=()=>f(this,null,function*(){return yield this._provider.cancelAction()});this.isInitialized=()=>this._provider.isInitialized();this.isConnected=()=>this._provider.isConnected();this.sendCustomRequest=o=>f(this,null,function*(){this._provider.sendPostMessage({type:o.request.method,payload:o.request.params})});this.getAddress=(0,w_.providerNotInitializedError)("getAddress");this._provider=v_.WebviewProvider.getInstance({resetStateCallback:()=>P.dispatch(ae())})}static getInstance(){return Ge._instance||(Ge._instance=new Ge),Ge._instance}getAccount(){var n;let o=this._provider.getAccount();return{address:(n=o==null?void 0:o.address)!=null?n:""}}setAccount(o){this._provider.setAccount(o)}};ee();ce();ve();Se();t();var Rn=require("react"),Li=require("@multiversx/sdk-extension-provider"),Ei=require("@multiversx/sdk-metamask-provider/out/metamaskProvider"),Pi=require("@multiversx/sdk-passkey-provider/out");Po();ee();var ut=()=>{let e=K(),{provider:o}=Je(),{nonce:n}=lo(),[r,a]=(0,Rn.useState)(null),[p,m]=(0,Rn.useState)(),[d,l]=(0,Rn.useState)([]),_=Rr(),u=w(br),g=w(hr),T=()=>f(void 0,null,function*(){var N,M;let S=Boolean(u==null?void 0:u.transactions),A=(N=u==null?void 0:u.transactions)!=null?N:[];if(S){let k=(M=u==null?void 0:u.customTransactionInformation)!=null&&M.skipUpdateNonces?A:yield _(A);l(k)}m(S)});(0,Rn.useEffect)(()=>{T()},[u,n]);let v=()=>{a(null),e(So(null))},y=S=>{v(),b(S)};tt(y);function b(S){var ie,U,W,J,R,V,B,se,re,ue,G,oe;let A=o instanceof Li.ExtensionProvider,N=o instanceof Pi.PasskeyProvider,M=o instanceof Te.CrossWindowProvider,k=o instanceof ze.IframeProvider,F=o instanceof Ei.MetamaskProvider,z=o instanceof Ge;e(Do()),e(Tn(S)),!(!A&&!M&&!k&&!N&&!F)&&(v(),A&&((U=(ie=Li.ExtensionProvider.getInstance())==null?void 0:ie.cancelAction)==null||U.call(ie)),N&&((J=(W=Pi.PasskeyProvider.getInstance())==null?void 0:W.cancelAction)==null||J.call(W)),F&&((V=(R=Ei.MetamaskProvider.getInstance())==null?void 0:R.cancelAction)==null||V.call(R)),M&&((se=(B=Te.CrossWindowProvider.getInstance())==null?void 0:B.cancelAction)==null||se.call(B)),k&&((ue=(re=ze.IframeProvider.getInstance())==null?void 0:re.cancelAction)==null||ue.call(re)),z&&((oe=(G=Ge.getInstance())==null?void 0:G.cancelAction)==null||oe.call(G)))}return{error:r,canceledTransactionsMessage:g,clearTransactionStatusMessage:v,onAbort:y,setError:a,hasTransactions:p,transactionsToSign:u&&D(h({},u),{transactions:d})}};var Fy=()=>{let e=K(),o=(0,gt.useRef)("/"),{provider:n}=Je(),r=w(sr),a=We(n),p=(0,gt.useRef)(!1),m=Rr(),{isGuarded:d,address:l}=lo(),_=w(hr),{transactionsToSign:u,error:g,setError:T,hasTransactions:v,onAbort:y,clearTransactionStatusMessage:b}=ut();tt(y);let S=(0,I_.default)(u==null?void 0:u.transactions.map(U=>U.getSender().toString()).filter(U=>U)),A=S==null?void 0:S[0],{data:N}=Ln(!A||A===l?null:A),M=U=>{var re,ue,G,oe,Be,He,Ce,ne,fe,$,Z,H;let W=n instanceof Ci.ExtensionProvider,J=n instanceof Ri.PasskeyProvider,R=n instanceof Te.CrossWindowProvider,V=n instanceof ze.IframeProvider,B=n instanceof Ni.MetamaskProvider,se=n instanceof Ge;e(Do()),e(Tn(U)),p.current=!1,!(!W&&!R&&!V&&!J&&!B)&&(b(),W&&((ue=(re=Ci.ExtensionProvider.getInstance())==null?void 0:re.cancelAction)==null||ue.call(re)),J&&((oe=(G=Ri.PasskeyProvider.getInstance())==null?void 0:G.cancelAction)==null||oe.call(G)),B&&((He=(Be=Ni.MetamaskProvider.getInstance())==null?void 0:Be.cancelAction)==null||He.call(Be)),R&&((ne=(Ce=Te.CrossWindowProvider.getInstance())==null?void 0:Ce.cancelAction)==null||ne.call(Ce)),V&&(($=(fe=ze.IframeProvider.getInstance())==null?void 0:fe.cancelAction)==null||$.call(fe)),se&&((H=(Z=Ge.getInstance())==null?void 0:Z.cancelAction)==null||H.call(Z)))},k=(U,W)=>{a==="walletconnectv2"&&(U=ho);let R=U.includes(ho);if(M(W),R){e(So(ho));return}T(U)},F=(U,W,J="")=>{let R={[ao]:W},V=J;if(window!=null&&window.location){let{search:se,origin:re}=q(),ue=new URLSearchParams(se);V=`${re}${J}`,ue.forEach((G,oe)=>{R[oe]=G})}let B=dr({callbackUrl:V,urlParams:R});n.signTransactions(U,{callbackUrl:encodeURIComponent(B)})},z=()=>f(void 0,null,function*(){var He,Ce;if(p.current||!u)return;let{sessionId:U,transactions:W,callbackRoute:J,customTransactionInformation:R}=u,{redirectAfterSign:V}=R,B=Xe(),se=J||B,re=B.includes(se),ue=V&&!re;try{if(!(yield(He=n==null?void 0:n.init)==null?void 0:He.call(n)))return}catch(ne){let fe=(ne==null?void 0:ne.message)||ne||pa;console.error(fe),k(pa,U);return}let G=!R.skipGuardian,oe=R.hasConsentPopup,Be=n instanceof Te.CrossWindowProvider;try{p.current=!0,Be&&oe&&n.setShouldShowConsentPopup(!0);let ne=(Ce=yield n.signTransactions(d&&G?W==null?void 0:W.map(O=>(O.setVersion($r.TransactionVersion.withTxOptions()),O.setOptions($r.TransactionOptions.withOptions({guarded:!0})),O)):W))!=null?Ce:[];if(p.current=!1,!Nr(ne))return;let $=Object.values(ne).map(O=>Oo(O)),{needs2FaSigning:Z,guardTransactions:H}=Fr({transactions:ne,sessionId:U,callbackRoute:J,isGuarded:d&&G,walletAddress:r});if(Z){let O=yield H();$=O?O.map(Y=>Oo(Y)):[]}let X={sessionId:U,transactions:$,status:"signed"};ue&&(X.redirectRoute=se),e(co(X))}catch(ne){p.current=!1;let fe=(ne==null?void 0:ne.message)||ne||ks;console.error(fe),e(co({sessionId:U,status:"cancelled"})),k(fe.includes("cancel")?ho:fe,U)}}),ie=()=>f(void 0,null,function*(){if(!u)return;b();let{sessionId:U,transactions:W,callbackRoute:J,customTransactionInformation:R}=u;if(!n){console.error(Ls);return}if(S.length>1)throw new Error("Multiple senders are not allowed");if(A&&A!==l&&!Cr(N,l))return console.error(Fn),k(Fn);o.current=J||q().pathname;try{let V=a==="wallet",B=R.skipUpdateNonces?W:yield m(W);if(V)return F(B,U,J);z()}catch(V){let se=(V==null?void 0:V.message)||As;console.error(se),k(se,U),e(co({sessionId:U,status:"cancelled"})),console.error(se,V)}});return(0,gt.useEffect)(()=>{v?ie():p.current=!1},[u,v,N]),{error:g,canceledTransactionsMessage:_,onAbort:y,hasTransactions:v,callbackRoute:o.current,sessionId:u==null?void 0:u.sessionId,transactions:u==null?void 0:u.transactions}};t();ee();le();Wn();Se();t();to();ee();function A_(){let e=K();return o=>{e(Do()),e(Tn(o)),e(So(ho))}}function Di(e){let{onCancel:o,verifyReceiverScam:n=!0,hasGuardianScreen:r}=e,{transactionsToSign:a,hasTransactions:p}=ut(),m=w(sr),d=Dd(),l=w(Wa),{account:_}=bi(),{address:u,isGuarded:g,activeGuardianAddress:T}=_,{provider:v,providerType:y}=Je(),b=K(),S=A_(),{transactions:A,sessionId:N,callbackRoute:M,customTransactionInformation:k}=a||{};function F(B){N&&b(co({sessionId:N,status:"cancelled"})),b(ep(B))}let{pathname:z}=q(),ie=M!=null&&z.includes(M),U=!(k!=null&&k.skipGuardian);function W(B){return f(this,null,function*(){if(!Nr(B))return;let{needs2FaSigning:re,guardTransactions:ue}=Fr({transactions:B,sessionId:N,callbackRoute:M,isGuarded:g&&U,walletAddress:m}),G=B.map(oe=>Oo(oe));if(re){let oe=yield ue();G=oe?oe.map(Be=>Oo(Be)):[]}!N||(b(co({sessionId:N,status:"signed",transactions:G})),M!=null&&(k==null?void 0:k.redirectAfterSign)&&!ie&&hn({url:M}))})}function J(){o(),S(N)}function R(B){return f(this,null,function*(){let se=y!=="ledger"?v:yield d();return B?yield se.signTransaction(B):null})}let V=Ti({address:u,egldLabel:l,activeGuardianAddress:g&&U?T:void 0,transactionsToSign:p?A:[],onGetScamAddressData:n?Em:null,isLedger:Ao("ledger"),hasGuardianScreen:r,onCancel:J,onSignTransaction:R,onTransactionsSignError:F,onTransactionsSignSuccess:W});return D(h({},V),{callbackRoute:M,waitingForDevice:V.waitingForDevice})}t();function Uy(e){return Di(e)}t();var ft=require("react");t();t();ce();yn();function By({transactionId:e,onSuccess:o,onFail:n,onCancelled:r,onTimedOut:a}){var k;let{signedTransactionsArray:p}=ot(),m=Ao("wallet"),[d]=p.length>0?p[p.length-1]:[],l=(k=e!=null?e:d)!=null?k:null,_=m?l:e,u=w(F=>hm(F,_)),{status:g,transactions:T,errorMessage:v}=u,y=so(g),b=Ro(g),S=Xt(g),A=No(g),N=g==="cancelled";function M(){m&&(b_(),Vr())}return(0,ft.useEffect)(()=>{A&&o&&o(_)},[A]),(0,ft.useEffect)(()=>{b&&n&&(n(_,v),M())},[b]),(0,ft.useEffect)(()=>{N&&r&&(r(_),M())},[N]),(0,ft.useEffect)(()=>{S&&(a?a(_):n==null||n(_,"timeout"))},[S]),_==null?{}:u==null?{errorMessage:"No transaction to track"}:{isPending:y,isSuccessful:A,isFailed:b,isCancelled:N,errorMessage:v,status:g,transactions:T}}t();var jr=require("react"),Wy=(e,o)=>{let[n,r]=(0,jr.useState)(e);return(0,jr.useEffect)(()=>{let p=setTimeout(()=>r(e),o);return()=>clearTimeout(p)},[e]),n};t();t();var Mi=require("react"),L_=require("@multiversx/sdk-extension-provider");to();me();ce();t();function be(){return Mo(P.getState())}yo();ve();ve();t();t();Po();le();var Oe=e=>(Object.values(_e).forEach(o=>{if(o!==(e==null?void 0:e.skipLoginMethod))switch(o){case"crossWindow":{let n=Te.CrossWindowProvider.getInstance();n.isInitialized()&&n.dispose();break}case"iframe":{let n=ze.IframeProvider.getInstance();n.isInitialized()&&n.dispose();break}default:break}}),null);t();var k_=require("react"),qr=require("@multiversx/sdk-core");ee();var Gy=(e,o)=>{var n;return o?o===!0?e:(n=o.apiAddress)!=null?n:e:null},ke=e=>{let o=w(xe),n=w(Vn),r=(0,k_.useRef)(n==null?void 0:n.loginToken),a=Gy(o.apiAddress,e),p=ct(h(h({},e===!0?{}:e),a?{apiAddress:a}:{})),m=Boolean(e),d=pt(p),{address:l}=lo(),_=K(),u=y=>{r.current=y,_(gn(h(D(h({},n),{loginToken:y}),a?{nativeAuthConfig:p}:{})))},g=()=>{try{return d.initialize()}catch(y){console.error("Unable to get block. Login failed.",y);return}},T=({address:y,signature:b})=>{let S=r.current;if(!S)throw"Token not found. Call `setLoginToken` first.";if(!m){_(gn({loginToken:S,signature:b}));return}let A=d.getToken({address:y,token:S,signature:b});return _(gn(h({loginToken:S,signature:b,nativeAuthToken:A},a?{nativeAuthConfig:p}:{}))),A};return{configuration:p,setLoginToken:u,getNativeAuthLoginToken:g,setTokenLoginInfo:T,refreshNativeAuthTokenLogin:S=>f(void 0,[S],function*({signMessageCallback:y,nativeAuthClientConfig:b}){let N=yield pt(b||p).initialize({noCache:Boolean(b)});if(r.current=N,!N)return;let M=new qr.Message({address:new qr.Address(l),data:i.Buffer.from(`${l}${N}`)}),k=yield y(M,{});if(!(k!=null&&k.signature))throw"Message not signed";return T({address:l,signature:i.Buffer.from(k.signature).toString("hex")})})}};var E_=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r})=>{let[a,p]=(0,Mi.useState)(""),[m,d]=(0,Mi.useState)(!1),l=n!=null,_=ke(n),u=o,g=K(),T=be();function v(){return f(this,null,function*(){if(T)throw new Error(we);Oe(),d(!0);let b=L_.ExtensionProvider.getInstance();try{if(!(yield b.init())){console.warn("Something went wrong trying to redirect to wallet login..");return}let A=Xe(),N=encodeURIComponent(xo(e!=null?e:A));if(l&&!u&&(u=yield _.getNativeAuthLoginToken(),!u)){console.warn("Fetching block failed. Login cancelled.");return}u&&_.setLoginToken(u);let M=h({callbackUrl:N},u&&{token:u}),{signature:k,address:F}=yield b.login(M);if(Ie(b),!F){d(!1),console.warn("Login cancelled."),p("Login cancelled");return}k&&u&&_.setTokenLoginInfo({signature:k,address:F}),g(pe({address:F,loginMethod:"extension"})),Ee({callbackRoute:e,onLoginRedirect:r,options:{signature:k,address:F}})}catch(S){console.error("error logging in",S),p("error logging in"+S.message)}finally{d(!1)}})}let y=Boolean(a);return[v,{loginFailed:y,error:a,isLoading:m&&!y,isLoggedIn:T&&!y}]};t();var Oi=require("react"),P_=require("@multiversx/sdk-opera-provider");to();me();ce();yo();ve();Se();var C_=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r})=>{let[a,p]=(0,Oi.useState)(""),[m,d]=(0,Oi.useState)(!1),l=n!=null,_=ke(n),u=o,g=K(),T=be();function v(){return f(this,null,function*(){if(T)throw new Error(we);Oe(),d(!0);let b=P_.OperaProvider.getInstance();try{if(!(yield b.init())){console.warn("Something went wrong trying to redirect to wallet login..");return}let{origin:A}=q(),N=Xe(),M=encodeURIComponent(`${A}${e!=null?e:N}`);if(l&&!u&&(u=yield _.getNativeAuthLoginToken(),!u)){console.warn("Fetching block failed. Login cancelled.");return}u&&_.setLoginToken(u);let k=h({callbackUrl:M},u&&{token:u});yield b.login(k),Ie(b);let{signature:F,address:z}=b.account;if(!z){d(!1),console.warn("Login cancelled.");return}F&&u&&_.setTokenLoginInfo({signature:F,address:z}),g(pe({address:z,loginMethod:"opera"})),Ee({callbackRoute:e,onLoginRedirect:r,options:{signature:F,address:z}})}catch(S){console.error("error loging in",S),p("error logging in"+S.message)}finally{d(!1)}})}let y=Boolean(a);return[v,{loginFailed:y,error:a,isLoading:m&&!y,isLoggedIn:T&&!y}]};t();var Fi=require("react");fa();to();Po();me();ee();ce();yo();Se();var N_=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r,hasConsentPopup:a,walletAddress:p})=>{let[m,d]=(0,Fi.useState)(""),[l,_]=(0,Fi.useState)(!1),u=n!=null,g=ke(n),T=o,v=w(xe),y=K(),b=be();function S(){return f(this,null,function*(){if(b)throw new Error(we);Oe({skipLoginMethod:"crossWindow"}),_(!0);let N=yield Te.CrossWindowProvider.getInstance().init(),M=Te.CrossWindowProvider.getInstance().setWalletUrl(p!=null?p:v.walletAddress);try{if(!N){console.warn("Something went wrong trying to redirect to wallet login..");return}let{origin:k,pathname:F}=q(),z=encodeURIComponent(`${k}${e!=null?e:F}`);if(u&&!T&&(T=yield g.getNativeAuthLoginToken(),!T)){console.warn("Fetching block failed. Login cancelled.");return}T&&g.setLoginToken(T);let ie=h({callbackUrl:z},T&&{token:T});(Ys&&u||a)&&M.setShouldShowConsentPopup(!0);let{signature:W,address:J,multisig:R,impersonate:V}=yield M.login(ie);if(Ie(M),!J){_(!1),console.warn("Login cancelled.");return}let B=yield Ld({loginToken:T,extraInfoData:{multisig:R,impersonate:V},address:J,signature:W,loginService:g});if(!B)return;y(pe({address:B.address,loginMethod:"crossWindow"})),y(dc(B.address)),y(un(D(h({},B),{nonce:Jo(B)}))),Ee({callbackRoute:e,onLoginRedirect:r,options:{signature:W,address:B.address}})}catch(k){console.error("error loging in",k),d("error logging in"+k.message)}finally{_(!1)}})}let A=Boolean(m);return[S,{loginFailed:A,error:m,isLoading:l&&!A,isLoggedIn:b&&!A}]};t();var Ui=require("react");to();ee();t();t();ha();t();t();var Hy=C(require("platform"));fn();t();t();t();t();t();t();t();pn();ce();t();t();var Vy=require("@multiversx/sdk-metamask-provider/out/metamaskProvider");t();t();Wn();_n();t();t();t();ee();t();t();var R_=C(require("axios"));function zr(e){return f(this,null,function*(){try{let{data:o}=yield R_.default.get(`${e}/websocket/config`);return`wss://${o.url}`}catch(o){throw console.error(o),new Error("Can not get websocket url")}})}ve();t();t();var F_=C(Br());pn();var D_,M_,O_,$y=(O_=(M_=(D_=De.safeWindow)==null?void 0:D_.location)==null?void 0:M_.origin)==null?void 0:O_.includes("localhost"),U_=e=>{if(!(0,F_.default)(e))return Boolean(e);let n=h({},e);return Boolean($y)&&delete n.origin,Object.keys(n).length>0};t();var B_=({maxRetries:e})=>new Promise((o,n)=>{let r=0,a=()=>{let p=$n(P.getState());if(p){o(p);return}if(r<e){r++,setTimeout(a,1e3);return}n(null)};a()});Se();t();var W_=(e,o=["address"])=>{let n=new URL(e),r=new URLSearchParams(n.search);o.forEach(m=>r.delete(m));let a=Array.from(r.values()).length>0?"?":"",p=n.pathname==="/"&&!e.endsWith("/")?"":n.pathname;return n.protocol==="vscode:"?e:`${n.origin}${p}${a}${r.toString()}${n.hash}`};var Kr=({callbackRoute:e,token:o,nativeAuth:n,redirectDelayMilliseconds:r=100,customWalletAddress:a})=>{let[p,m]=(0,Ui.useState)(""),[d,l]=(0,Ui.useState)(!1),_=w(xe),u=K(),g=be(),T=Boolean(n),v=ke(n),y=o;function b(){return f(this,null,function*(){if(g)throw new Error(we);u(Wc(a));try{l(!0);let A=Ar(a!=null?a:_.walletAddress),N=new Date,M=N.setMinutes(N.getMinutes()+3)/1e3,k={data:{},expires:M};if(T&&!y&&(y=yield v.getNativeAuthLoginToken(),!y)){console.warn("Login cancelled.");return}y&&v.setLoginToken(y);let{origin:F}=q(),z=window!=null&&window.location?`${F}${e}`:`${e}`;new URLSearchParams(document==null?void 0:document.location.search).get("address")||u(yc(k));let W=W_(z),J=encodeURIComponent(W),R=D(h({callbackUrl:J},y&&{token:y}),{redirectDelayMilliseconds:r});yield A.login(R)}catch(A){console.error(A),m("error logging in"+A.message)}finally{l(!1)}})}let S=Boolean(p);return[b,{error:p,loginFailed:S,isLoading:d&&!S,isLoggedIn:g&&!S}]};t();var nu=require("react");j();t();t();j();var G_=e=>{var a;let o=w(Vn),n=(a=o==null?void 0:o.loginToken)!=null?a:e;if(!n)return;let r=Zo(n);if(!!r)return r.origin.toLowerCase().startsWith(qs)};t();t();t();var jy=C(require("bignumber.js"));t();t();t();var Bo=C(require("react")),Z_=require("react"),Q_=require("react"),qi=C(require("classnames")),eu=require("react-dom");j();t();var j_=C(require("react"));t();var ht=C(require("react"));t();fn();var H_=()=>!To();var zy=()=>f(void 0,null,function*(){return yield Promise.resolve().then(()=>(Wi(),Bi))}),Ky=()=>(Wi(),Ze(Bi)).default,Gi=H_();function $_({ssrGlobalImportCallback:e,ssrImportCallback:o,clientImportCallback:n}){let[r,a]=ht.default.useState(Gi?void 0:Ky()),[p,m]=ht.default.useState(Gi||n==null?void 0:n()),d=()=>f(this,null,function*(){(e?e():zy()).then(l=>a(l.default)),o==null||o().then(l=>m(l.default))});return(0,ht.useEffect)(()=>{Gi&&d()},[]),{globalStyles:r,styles:p}}function Uo(e,o){return n=>{let{globalStyles:r,styles:a}=$_({ssrGlobalImportCallback:o.ssrGlobalStyles,ssrImportCallback:o.ssrStyles,clientImportCallback:o.clientStyles});return j_.default.createElement(e,D(h({},n),{globalStyles:r!=null?r:{},styles:a!=null?a:{}}))}}t();var z_=C(require("react")),K_=C(require("classnames"));var Yy=({className:e,children:o,styles:n})=>z_.default.createElement("div",{className:(0,K_.default)(n==null?void 0:n.dappModalBody,e)},o),Hi=Uo(Yy,{ssrStyles:()=>Promise.resolve().then(()=>(Lo(),ko)),clientStyles:()=>(Lo(),Ze(ko)).default});t();var Vi=C(require("react")),X_=C(require("classnames"));var Jy=({visible:e,customFooter:o,className:n,footerText:r,styles:a})=>e?Vi.default.createElement("div",{className:(0,X_.default)(a==null?void 0:a.dappModalFooter,n)},o!=null?o:Vi.default.createElement("div",null,r)):null,$i=Uo(Jy,{ssrStyles:()=>Promise.resolve().then(()=>(Lo(),ko)),clientStyles:()=>(Lo(),Ze(ko)).default});t();var Dn=C(require("react")),Y_=require("@fortawesome/free-solid-svg-icons"),J_=require("@fortawesome/react-fontawesome"),Tt=C(require("classnames"));var Zy=({visible:e,headerText:o,customHeader:n,className:r,closeButtonClassName:a,headerTextClassName:p,onHide:m,globalStyles:d,styles:l})=>e?n?Dn.default.createElement("div",{className:(0,Tt.default)(l==null?void 0:l.dappModalHeader,r)},n):Dn.default.createElement("div",{className:(0,Tt.default)(l==null?void 0:l.dappModalHeader,r)},Dn.default.createElement("div",{className:(0,Tt.default)(l==null?void 0:l.dappModalHeaderText,p)},o),Dn.default.createElement("button",{onClick:m,className:(0,Tt.default)(l==null?void 0:l.dappModalCloseButton,d==null?void 0:d.btn,d==null?void 0:d.btnLight,a)},Dn.default.createElement(J_.FontAwesomeIcon,{size:"lg",icon:Y_.faTimes}))):null,ji=Uo(Zy,{ssrStyles:()=>Promise.resolve().then(()=>(Lo(),ko)),clientStyles:()=>(Lo(),Ze(ko)).default});var Qy={showHeader:!0,showFooter:!1,headerText:"",footerText:""},eS=({"data-testid":e="dappModal",children:o,className:n="dapp-modal-dialog-wrapper",closeOnEscape:r,config:a=Qy,id:p="dapp-modal",onHide:m,parentElement:d,visible:l,styles:_})=>{let[u,g]=(0,Z_.useState)(!1);if((0,Q_.useEffect)(()=>{g(!0)},[]),!l)return null;let{showHeader:T,showFooter:v,headerText:y,footerText:b,modalDialogClassName:S="dapp-modal-dialog",modalContentClassName:A="dapp-modal-dialog-content",modalHeaderClassName:N="dapp-modal-dialog-header",modalHeaderTextClassName:M="dapp-modal-dialog-header-text",modalCloseButtonClassName:k="dapp-modal-dialog-close-button",modalBodyClassName:F="dapp-modal-dialog-content-body",modalFooterClassName:z="dapp-modal-dialog-footer",customModalHeader:ie,customModalFooter:U}=a,W=J=>{J.key==="Escape"&&r&&(m==null||m())};return Bo.default.createElement(Bo.default.Fragment,null,u&&(0,eu.createPortal)(Bo.default.createElement("div",{id:p,role:"dialog","aria-modal":"true",className:(0,qi.default)(S,_==null?void 0:_.dappModal,n),"data-testid":e,onKeyDown:W},Bo.default.createElement("div",{className:(0,qi.default)(_==null?void 0:_.dappModalContent,A)},Bo.default.createElement(ji,{visible:T,headerText:y,customHeader:ie,className:N,headerTextClassName:M,closeButtonClassName:k,onHide:m}),Bo.default.createElement(Hi,{className:F},o),Bo.default.createElement($i,{visible:v,customFooter:U,footerText:b,className:z}))),d!=null?d:document==null?void 0:document.body))},oS=Uo(eS,{ssrStyles:()=>Promise.resolve().then(()=>(Lo(),ko)),clientStyles:()=>(Lo(),Ze(ko)).default});t();t();var Xr=require("react"),ou=e=>{let[o,n]=(0,Xr.useState)(!1),r=()=>{n(!0)},a=()=>{n(!1)};return(0,Xr.useEffect)(()=>{(e==null?void 0:e.visible)===!0?r():(e==null?void 0:e.visible)===!1&&a()},[e==null?void 0:e.visible]),{handleShowModal:r,handleHideModal:a,showModal:o}};t();var tu=({hideButtonWhenModalOpens:e,onContentHide:o,onContentShow:n,onModalCloses:r,onModalOpens:a,token:p,wrapContentInsideModal:m})=>{let d=Ai(),[l,_]=(0,nu.useState)(!1),{handleShowModal:u,handleHideModal:g,showModal:T}=ou(),v=G_(p),y=!e||!l,b=()=>{_(!1),o==null||o(),m?(g(),r==null||r()):r&&(console.warn('Deprecated: "onModalCloses" must be used only when "wrapContentInsideModal" is set to "true". Use "onContentHide" instead.'),r())};return{disabledConnectButton:v,handleCloseModal:b,handleOpenModal:()=>{if(d)throw new Error(we);if(l)return b();_(!0),n==null||n(),m?(u(),a==null||a()):a&&(console.warn('Deprecated: "onModalOpens" must be used only when "wrapContentInsideModal" is set to "true". Use "onContentShow" instead.'),a())},shouldRenderButton:y,showContent:l,showModal:T}};t();var Mn=require("react"),zi=require("@multiversx/sdk-hw-provider");to();me();ee();ce();yo();t();var nn=require("react"),nS=10,ru=()=>{let[e,o]=(0,nn.useState)(""),[n,r]=(0,nn.useState)(!1),[a,p]=(0,nn.useState)(0),[m,d]=(0,nn.useState)([]),[l,_]=(0,nn.useState)(null),[u,g]=(0,nn.useState)(!1);return{accounts:m,defaultAddressesPerPage:nS,error:e,isLoading:n,onGoToNextPage:()=>{_(null),p(S=>S+1)},onGoToPrevPage:()=>{_(null),p(S=>S===0?0:S-1)},onGoToSpecificPage:S=>{_(null),p(S)},onSelectAddress:S=>{_(S)},selectedAddress:l,setAccounts:d,setError:o,setIsLoading:r,setShowAddressList:g,showAddressList:u,startIndex:a}};var xt="Check if the MultiversX App is open on Ledger",au=({callbackRoute:e,token:o,addressesPerPage:n,nativeAuth:r,onLoginRedirect:a})=>{let p=w(Np),m=Ae(),d=K(),l=be(),_=r!=null,u=ke(r),g=o,{accounts:T,setAccounts:v,isLoading:y,setIsLoading:b,setShowAddressList:S,showAddressList:A,startIndex:N,selectedAddress:M,onGoToPrevPage:k,onGoToNextPage:F,onGoToSpecificPage:z,onSelectAddress:ie,error:U,setError:W,defaultAddressesPerPage:J}=ru(),R=n!=null?n:J,[V,B]=(0,Mn.useState)(""),[se,re]=(0,Mn.useState)(!1),ue=({address:H,index:X,signature:O})=>{d(xc({index:X,loginType:"ledger"})),O&&u.setTokenLoginInfo({signature:O,address:H}),d(pe({address:H,loginMethod:"ledger"})),Ee({callbackRoute:e,onLoginRedirect:a,options:{address:H,signature:O}})},G=(H,X="")=>{var O;if(y){let{errorMessage:Y,defaultErrorMessage:Q}=Wt(H),te=(O=Y!=null?Y:Q)!=null?O:xt;W(`${te}.${X}`),b(!1),d(va(null))}},oe=()=>f(void 0,null,function*(){try{if(m instanceof zi.HWProvider&&m.isInitialized())return m.isConnected()}catch(H){G(H)}return!1}),Be=()=>f(void 0,null,function*(){if(yield oe()){W(""),b(!1);return}try{let X=new zi.HWProvider;(yield X.init())&&Ie(X),W(""),b(!1)}catch(X){G(X)}}),He=()=>f(void 0,null,function*(){let H=yield oe();if(!M||!H)return G(xt);let{index:X}=M;if(_&&!g&&(g=yield u.getNativeAuthLoginToken(),!g)){console.warn("Fetching block failed. Login cancelled.");return}if(g){u.setLoginToken(g);try{let O=yield m.tokenLogin({token:i.Buffer.from(`${g}{}`),addressIndex:X});ue({address:O.address,index:X,signature:O.signature.toString("hex")})}catch(O){G(O,". Update MultiversX App to continue.")}}else try{let{address:O}=yield m.login({addressIndex:X});ue({address:O,index:X})}catch(O){return G(O),!1}return!0}),Ce=()=>f(void 0,null,function*(){try{if(b(!0),M==null)return!1;d(p?lc(M):va(D(h({},M),{version:V,hasContractDataEnabled:se}))),b(!1),yield He()}catch(H){G(H)}return S(!1),!0}),ne=()=>f(void 0,null,function*(){if(!(yield oe()))return G(U);try{b(!0);let X=yield m.getAccounts(N,R),O=yield kr(m);B(O.version),re(O.dataEnabled),v(X),b(!1)}catch(X){G(X)}}),fe=()=>f(void 0,null,function*(){if(l)throw new Error(we);Oe(),W("");try{if(b(!0),!(yield oe()))return G(xt);if(p!=null){if(!M)return G(xt);let{address:X}=yield m.login({addressIndex:M.index.valueOf()});if(!X)return G("Login cancelled.");d(pe({address:X,loginMethod:"ledger"})),Ee({callbackRoute:e,onLoginRedirect:a})}else T!=null&&T.length||(yield ne()),S(!0);b(!1)}catch(H){G(H)}}),$=()=>f(void 0,null,function*(){try{let H=yield oe();if(H||(yield Be()),H=yield oe(),!H)return G(xt);(T.length===0||N>=0)&&(yield ne())}catch(H){G(H)}});(0,Mn.useEffect)(()=>{$()},[N,A,m]),(0,Mn.useEffect)(()=>{(T==null?void 0:T.length)>0&&!A&&S(!0)},[T]);let Z=Boolean(U);return[fe,{loginFailed:Z,isLoggedIn:l&&!Z,error:U,isLoading:y&&!Z},{accounts:T,showAddressList:A,startIndex:N,selectedAddress:M,version:V,contractDataEnabled:se,onGoToPrevPage:k,onGoToNextPage:F,onGoToSpecificPage:z,onSelectAddress:ie,onConfirmSelectedAddress:Ce}]};t();var iu=e=>{var n;let o=w(zp);return Kr(D(h({},e),{customWalletAddress:(n=e.customWalletAddress)!=null?n:o}))};t();var Fe=require("react");me();ee();ce();yo();Se();var su=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r,logoutRoute:a,customRequestMethods:p=[]})=>{var X;let m=K(),d=U_(n),l=ke(d?n:!1),_=o,[u,g]=(0,Fe.useState)(""),[T,v]=(0,Fe.useState)(""),[y,b]=(0,Fe.useState)(!0),[S,A]=(0,Fe.useState)([]),[N,M]=(0,Fe.useState)(null),{provider:k}=Je(),F=w(Hp),z=w(Vp),ie=w($p),U=w(jp),W=w(ar),J=w(Mp),R=(0,Fe.useRef)(k),V=(0,Fe.useRef)(!1),B=(0,Fe.useRef)(!1),se=(X=a!=null?a:W)!=null?X:"/",re=[vr.CANCEL_ACTION,...p];o&&re.push(vr.SIGN_LOGIN_TOKEN),d&&re.push(vr.SIGN_NATIVE_AUTH_TOKEN);let ue=y?"":`${U}?wallet-connect=${encodeURIComponent(T)}`,G=Boolean(u),oe=be(),Be=()=>{mt(se)},He=O=>{console.log("WalletConnect Session Event: ",O)},Ce=()=>f(void 0,null,function*(){var O,Y,Q,te;try{if(V.current||R.current==null)return;if(!B.current){try{yield(O=R.current)==null?void 0:O.logout()}catch(Yr){console.warn("Unable to logout")}return}let ge=yield(Q=(Y=R.current)==null?void 0:Y.getAddress)==null?void 0:Q.call(Y);if(!ge){console.warn("Login cancelled.");return}let ye=yield(te=R.current)==null?void 0:te.getSignature(),Le={address:ge,loginMethod:"walletconnectv2"},Ve={logoutRoute:se,loginType:"walletconnectv2",callbackRoute:e!=null?e:q().href};m(Tc(Ve)),ye&&l.setTokenLoginInfo({signature:ye,address:ge}),m(pe(Le)),Ee({callbackRoute:e,onLoginRedirect:r,options:{address:ge,signature:ye}})}catch(ge){g("User rejected connection proposal"),console.error(ge)}}),ne=()=>f(void 0,null,function*(){var Y,Q,te,ge,ye;if(We(R.current)==="walletconnectv2")try{((ge=(te=(Q=(Y=R.current)==null?void 0:Y.walletConnector)==null?void 0:Q.session)==null?void 0:te.getAll())!=null?ge:[]).length>0&&(yield(ye=R.current)==null?void 0:ye.logout()),R.current=Qn,M(null)}catch(Le){console.warn("Unable to logout")}}),fe=O=>f(void 0,null,function*(){var Y,Q,te;if(!F||!z){g("Invalid WalletConnect setup");return}if(!O||!O.topic){g("Expired connection");return}try{if((R.current?We(R.current):!1)!=="walletconnectv2"){yield Z();return}if(b(!0),yield ne(),d&&!_&&(_=yield l.getNativeAuthLoginToken(),!_)){console.warn("Fetching block failed. Login cancelled.");return}_&&l.setLoginToken(_),yield Z(!1);let{approval:ye}=yield(Y=R.current)==null?void 0:Y.connect({topic:O.topic,methods:re});try{yield(Q=R.current)==null?void 0:Q.login({approval:ye,token:_})}catch(Le){console.error("User rejected existing connection proposal",Le),g("User rejected existing connection proposal"),b(!0),yield Z()}}catch(ge){console.error("Unable to connect to existing session",ge),g("Unable to connect to existing session")}finally{A((te=R.current)==null?void 0:te.pairings)}}),$=O=>f(void 0,null,function*(){var Y,Q;try{O&&(yield(Y=R.current)==null?void 0:Y.logout({topic:O}))}catch(te){console.error("Unable to remove existing pairing",te),g("Unable to remove existing pairing")}finally{let te=yield(Q=R.current)==null?void 0:Q.getPairings();A(te)}});function Z(O=!0){return f(this,null,function*(){var Ve,Yr,Qi;Oe();let Y=yield B_({maxRetries:15});if(!Y){console.error("Invalid chainID"),g("Invalid chainID");return}if(!z||!F){console.error("Invalid WalletConnect setup"),g("Invalid WalletConnect setup");return}let Q=be(),te=B.current===!1&&!Q,ge=(Yr=(Ve=R.current)==null?void 0:Ve.isInitialized)==null?void 0:Yr.call(Ve);if(V.current||te||ge)return;if(V.current=!0,(Qi=R.current)!=null&&Qi.walletConnector){yield R.current.init(),M(R.current),V.current=!1,O&&(yield H());return}let ye={onClientLogin:Ce,onClientLogout:Be,onClientEvent:He},Le=new Ir(ye,Y,F,z,ie);yield Le.init(),M(Le),R.current=Le,V.current=!1,O&&(A(Le.pairings),yield H())})}function H(){return f(this,null,function*(){var O,Y;if(!!R.current){if(!F||!z){g("Invalid WalletConnect setup");return}try{if(!B.current)return;let{uri:Q,approval:te}=yield(O=R.current)==null?void 0:O.connect({methods:re});if(!Boolean(Q))return;if(v(Q),(ie==null?void 0:ie.logger)==="debug"&&console.log("WalletConnect uri: ",Q),d&&!_&&(_=yield l.getNativeAuthLoginToken(),!_)){console.warn("Fetching block failed. Login cancelled.");return}if(_&&l.setLoginToken(_),(R.current?We(R.current):!1)!=="walletconnectv2"){b(!0),yield Z();return}try{yield(Y=R.current)==null?void 0:Y.login({approval:te,token:_})}catch(Le){console.error("User rejected connection proposal",Le),g("User rejected connection proposal"),b(!0)}}catch(Q){console.error("Unable to connect",Q)}}})}return ni(()=>{R.current=k},[k]),(0,Fe.useEffect)(()=>(B.current=!0,()=>{B.current=!1}),[]),(0,Fe.useEffect)(()=>{b(!T)},[T]),(0,Fe.useEffect)(()=>{if(!N)return;(Boolean(N.session)||J==="walletconnectv2")&&oe&&Ie(N)},[N,oe]),[Z,{error:u,loginFailed:G,isLoading:y&&!G,isLoggedIn:oe&&!G},{uriDeepLink:ue,walletConnectUri:T,cancelLogin:ne,connectExisting:fe,removeExistingPairing:$,wcPairings:S}]};t();var Ki=require("react"),cu=require("@multiversx/sdk-metamask-provider/out/metamaskProvider");to();me();ce();yo();ve();ve();var pu=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r})=>{let[a,p]=(0,Ki.useState)(""),[m,d]=(0,Ki.useState)(!1),l=n!=null,_=ke(n),u=o,g=K(),T=be();function v(){return f(this,null,function*(){if(T)throw new Error(we);Oe(),d(!0);let b=cu.MetamaskProvider.getInstance();try{if(!(yield b.init())){console.warn("Something went wrong trying to redirect to wallet login..");return}let A=Xe(),N=encodeURIComponent(xo(e!=null?e:A));if(l&&!u&&(u=yield _.getNativeAuthLoginToken(),!u)){console.warn("Fetching block failed. Login cancelled.");return}u&&_.setLoginToken(u);let M=h({callbackUrl:N},u&&{token:u});yield b.login(M),Ie(b);let{signature:k,address:F}=b.account;if(!F){d(!1),console.warn("Login cancelled."),p("Login cancelled");return}k&&u&&_.setTokenLoginInfo({signature:k,address:F}),g(pe({address:F,loginMethod:"metamask"})),Ee({callbackRoute:e,onLoginRedirect:r,options:{signature:k,address:F}})}catch(S){console.error("error logging in",S),p("error logging in"+S.message)}finally{d(!1)}})}let y=Boolean(a);return[v,{loginFailed:y,error:a,isLoading:m&&!y,isLoggedIn:T&&!y}]};t();var Xi=require("react"),Yi=require("@multiversx/sdk-passkey-provider/out");to();me();ce();yo();ve();ve();var mu=({callbackRoute:e,token:o,nativeAuth:n,onLoginRedirect:r})=>{let[a,p]=(0,Xi.useState)(""),[m,d]=(0,Xi.useState)(!1),l=n!=null,_=ke(n),u=o,g=K(),T=be();function v(){return f(this,null,function*(){if(T)throw new Error(we);Oe(),d(!0);let S=Yi.PasskeyProvider.getInstance();try{if(!(yield S.init())){console.warn("Something went wrong trying to redirect to wallet login..");return}let N=Xe(),M=encodeURIComponent(xo(e!=null?e:N));if(l&&!u&&(u=yield _.getNativeAuthLoginToken(),!u)){console.warn("Fetching block failed. Login cancelled.");return}u&&_.setLoginToken(u);let k=h({callbackUrl:M},u&&{token:u});yield S.login(k),Ie(S);let{signature:F,address:z}=S.account;if(!z){d(!1),console.warn("Login cancelled."),p("Login cancelled");return}F&&u&&_.setTokenLoginInfo({signature:F,address:z}),g(pe({address:z,loginMethod:"passkey"})),Ee({callbackRoute:e,onLoginRedirect:r,options:{signature:F,address:z}})}catch(A){console.error("error logging in",A),p("Error logging in: "+A.message)}finally{d(!1)}})}let y=S=>f(void 0,null,function*(){let A=Yi.PasskeyProvider.getInstance();return yield A.init(),yield A.createAccount({walletName:S})}),b=Boolean(a);return[v,y,{loginFailed:b,error:a,isLoading:m&&!b,isLoggedIn:T&&!b}]};t();t();var yt=require("react");function tS(e){let[o,n]=(0,yt.useState)(),[r,a]=(0,yt.useState)();function p(){return f(this,null,function*(){try{let m=yield zr(e);n(m)}catch(m){a(m)}})}return(0,yt.useEffect)(()=>{p()},[]),{data:o,error:r,getUrl:p}}t();var Ji=require("react");t();var Wo=require("react"),_u=require("socket.io-client");ee();t();var Ue={current:null,status:"not_initialized"};var rS=3e3,aS=3,du=500,lu=1e3,iS="batchUpdated",sS="connect",cS="disconnect";function uu(){let e=(0,Wo.useRef)(null),o=(0,Wo.useRef)(null),{address:n}=lo(),r=K(),{network:a}=Jn(),p=_=>{e.current&&clearTimeout(e.current),e.current=setTimeout(()=>{r(_c(_))},lu)},m=_=>{o.current&&clearTimeout(o.current),o.current=setTimeout(()=>{r(uc(_))},lu)},d=()=>{var _;(_=Ue.current)==null||_.close(),Ue.current=null,Ue.status="not_initialized",e.current&&clearTimeout(e.current)},l=(0,Wo.useCallback)(Dr(()=>f(this,null,function*(){var u;if(!n)return;Ue.status="pending";let _=(u=a.websocketUrl)!=null?u:yield zr(a.apiAddress);if(_==null){console.warn("Can not get websocket url");return}Ue.current=(0,_u.io)(_,{forceNew:!0,reconnectionAttempts:aS,timeout:rS,query:{address:n}}),Ue.status="completed",Ue.current.onAny(p),Ue.current.on(iS,m),Ue.current.on(sS,()=>{console.log("Websocket connected.")}),Ue.current.on(cS,()=>{n&&(console.warn("Websocket disconnected. Trying to reconnect..."),setTimeout(()=>{var g;n&&(console.log("Websocket reconnecting..."),(g=Ue.current)==null||g.connect())},du))})}),{retries:2,delay:du}),[n]);(0,Wo.useEffect)(()=>{var _;if(n&&Ue.status==="not_initialized"&&!((_=Ue.current)!=null&&_.active)){l();return}n||d()},[n,l]),(0,Wo.useEffect)(()=>()=>{d()},[])}function pS(e,o){uu();let n=ki(),r=wi();(0,Ji.useEffect)(()=>{let a=n==null?void 0:n.message;a&&e(a)},[e,n]),(0,Ji.useEffect)(()=>{let a=r==null?void 0:r.data;a&&(o==null||o(a))},[o,r])}t();t();var Zi=require("react");le();var gu=()=>{let e=w(pr),o=w(Ga),{signedTransactions:n}=ot(),r=(0,Zi.useMemo)(()=>e.map(p=>{var d,l,_,u,g;let m=(d=n[p.toastId])==null?void 0:d.status;return{sessionId:p.toastId,baseTransactionsInfo:(l=o[p.toastId])!=null?l:{},customTransactionsInfo:(g=(u=(_=n[p.toastId])==null?void 0:_.customTransactionInformation)==null?void 0:u.sessionInformation)!=null?g:{},status:m,isPending:m!=="success"&&m!=="fail"&&m!=="cancelled"}}),[e,n,o]),a=(0,Zi.useMemo)(()=>r.filter(p=>p.isPending),[r]);return{transactionsToastsInfo:r,pendingTransactionsToastsInfo:a}};t();var fu=()=>{let e=w(Xp),o=w(pr);return{customToasts:e,transactionToasts:o}};t();t();var xu=C(require("swr"));t();t();t();t();var hu=C(require("axios"));function Tu(e=zn){let n=`${Yo()}/${e}`;return hu.default.get(n)}t();function mS(){let e=r=>Tu(r).then(a=>a.data),{data:o,error:n}=(0,xu.default)(zn,e);return{price:o==null?void 0:o.price,error:n}}0&&(module.exports={useCheckTransactionStatus,useCrossWindowLogin,useDebounce,useExtensionLogin,useGetAccount,useGetAccountInfo,useGetAccountProvider,useGetActiveTransactionsStatus,useGetBatchWebsocketEvent,useGetEgldPrice,useGetFailedTransactions,useGetIsLoggedIn,useGetIsWalletConnectV2Initialized,useGetLastPendingTransactionHash,useGetLoginInfo,useGetModalLoginMethods,useGetNetworkConfig,useGetNotification,useGetPendingTransactions,useGetPollingInterval,useGetSignTransactionsError,useGetSignedTransactions,useGetSuccessfulTransactions,useGetToasts,useGetTokenDetails,useGetTransactionDisplayInfo,useGetWebsocketEvent,useGetWebsocketUrl,useLedgerLogin,useMetamaskLogin,useOperaLogin,useParseMultiEsdtTransferData,useParseSignedTransactions,usePasskeyLogin,useRegisterWebsocketListener,useSignMultipleTransactions,useSignTransactions,useSignTransactionsCommonData,useSignTransactionsWithDevice,useSignTransactionsWithLedger,useTrackTransactionStatus,useTransactionsToasts,useUpdateEffect,useWalletConnectV2Login,useWebWalletLogin,useXaliasLogin});
/*!
